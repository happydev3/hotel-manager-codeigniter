...
<div class="wraper container-fluid">
	<div class="page-title">
		<h3 class="title">B2C Markup Manager (Hotel)</h3>
	</div>
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-default">
					...
					<div class="col-lg-12">
						<div id="collapseOne-2" class="panel-collapse">
							<div class="panel-body">
								<form action="{{url('b2c/hotels/markup')}}" method="post">
				...
				<div class="panel-body">
					<table id="datatable-buttons" class="table table-striped table-bordered">
						...
						<tbody>
							@forelse($markup_info as $key=>$val)
							<tr>
								<td>{{$key+1}}</td>
								<td>{{$val->api_name}}</td>
								<td>{{DB::table('api_permanent_hotels')->where('hotel_code', $val->hotel)->value('hotel_name')}}</td>
