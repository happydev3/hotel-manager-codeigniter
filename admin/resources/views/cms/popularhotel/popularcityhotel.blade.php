...
<div class="wraper container-fluid">
	<div class="page-title"> 
		<h3 class="title">Popular Hotel City</h3> 
	</div>
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					 <form action="{{ url('cms/popularcityhotel')}}" method="post" enctype="multipart/form-data" data-parsley-validate>
					 	{{ csrf_field() }}
						<div>							
							<section>
								<div class="row"> 
									<div class="col-md-4"> 
										<div class="form-group"> 
											<label for="title" class="control-label">City Name</label>
											 <select  id="popularcityhotellist" name="name" class="form-control" tabindex="-1" required="required"></select> 
										</div> 
									</div>
							       <div class="col-md-1"> 
										<div class="form-group"> 
					...
					<table id="datatable-buttons" class="table table-striped table-bordered">
						...
						<tbody>
							...
							<tr>
								 ...
								 <td>
									@if($val->status==0)
									<a href="{{ url('cms/popularcityhotel/status/'.$val->id.'/1')}}" class="label label-success" title="Active"><i class="fa fa-check"></i></a>
									@elseif($val->status==1)
									<a href="{{ url('cms/popularcityhotel/status/'.$val->id.'/0')}}" class="label label-danger" title="In active"><i class="fa fa-remove"></i></a>
									@endif
									<a href="{{url('cms/popularhotel/add/'.$val->id)}}" class="label label-info" title="Add Hotel"><i class="fa fa-edit"></i>Add Hotel</a>
								</td>
							</tr>
							@empty
							<div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/parsley.js/2.8.0/parsley.js"></script>
 <script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.5/js/select2.js"></script>
  ...
  $('#popularcityhotellist').select2({
    ...
    ajax: {
        url: "{{ url('popularcityhotel/citylist')}}",
        dataType: "json",
        type: "GET",
