					...
					<table id="datatable-buttons" class="table table-striped table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									@if($val->status==0)
									<a href="{{ url('b2b/hotels/apiinfo/status/').'/'.$val->id.'/1'}}" class="label label-success" title="Active"><i class="fa fa-check"></i></a>
									@elseif($val->status==1)
									<a href="{{ url('b2b/hotels/apiinfo/status/').'/'.$val->id.'/0'}}" class="label label-warning" title="In active"><i class="fa fa-remove"></i></a>
									@endif
