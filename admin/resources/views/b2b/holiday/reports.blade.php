...
<div class="wraper container-fluid">
	<div class="page-title"> 
		<h3 class="title">B2B Reports Manager (Tours)</h3> 
	</div>
	<div class="row">
		<div class="col-md-12">
					...
					<div class="col-lg-12">
						<div id="collapseOne-2" class="panel-collapse collapse in">
							<div class="panel-body">
								<form action="{{url('b2b/holidays/reports')}}" method="get">
									<div>
										<section>
					...
					<table id="datatable-buttons" class="table table-striped table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="{{url('b2b/holidays/reports/voucher').'/'.$report->uniqueRefNo.'?sendmail=0'}}" class="label label-success" title="Print Ticket" target="_blank" style="display: inline-block;margin-bottom: 2px;"><i class="fa fa-ticket"></i> Ticket</a>
									...
									<a href="{{url('b2b/holidays/reports/voucher').'/'.$report->uniqueRefNo.'?sendmail=1'}}" target="_blank" class="label label-warning" title="Send Email" style="display: inline-block;margin-bottom: 2px;"><i class="fa fa-envelope"></i> Email</a>
