...
<div class="wraper container-fluid">
	<div class="page-title">
		<h3 class="title">Supplier Villa List  ({{$supplier_name}})</h3>
	</div>
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-default">
				<!-- <div class="panel-heading">
					<h3 class="panel-title"><a data-type="villa" href="javascript:;" class="label label-success add_selected" title="Add Discounts" style="color: #fff"><i class="fa fa-plus"></i> Click to add/update discounts</a></h3>
				</div> -->
						...
						<table id="datatable-buttons" class="table table-striped table-bordered">
							...
							<tbody>
								...
								<tr>
									...
									<td>{{$val->price}}</td>
									<td>
										<a href="{{url('suppliers/villas/preview')}}/<?php echo base64_encode($val->property_code) ?>" class="label label-info" title="Preview" target="_blank"><i class="fa fa-eye"></i></a>
									</td>
									<td>
										<?php if($val->status==1) { ?>
									...
									<td>
										@if($val->status==0)
										<a href="{{ url('suppliers/villas/status/'.$val->id.'/'.$val->supplier_id.'/1')}}" class="label label-success" title="Active"><i class="fa fa-check"></i></a>
										@elseif($val->status==1)
										<a href="{{ url('suppliers/villas/status/'.$val->id.'/'.$val->supplier_id.'/0')}}" class="label label-warning" title="In active"><i class="fa fa-remove"></i></a>
										@endif
									</td>
								</tr>
								@endforeach
