...
function filter($sortBy,$order) {
    ...
    $.post(siteUrl+"villa/searchresult_ajax", {ses_id: ""+ses_id, refNo: ""+refNo,minPrice: ""+$minPr, maxPrice: ""+$maxPr, starRating: ""+$starShow,fac:""+$fac, villaName: ""+$villaName,location: ""+$locationShow, sortBy: ""+$sort_data, order: ""+$sort_order, ListMapView:""+$ListMapView},
