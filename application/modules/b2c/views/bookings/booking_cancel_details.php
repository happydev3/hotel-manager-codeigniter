          ...
          <table class="table table-bordered dataTable" id="hotel_bookings">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?php echo $book_details->city_code; ?></td>
                ...
                <td><?php echo $book_details->Booking_Amount; ?></td>
                <td><?php echo $book_details->Booking_Status; ?></td>
                <td><?php echo $DisplayCurrencyCode ?> <?php echo $CancellationCharge ?></td>
                <td>
                  <?php if( $book_details->Booking_Status == 'Cancelled') { ?>
                  <span>Ticket Already Cancelled</span>
                  <?php } ?>
                  <?php if($book_details->Cancellation_Status != 'Cancelled' && $book_details->Booking_Status == 'Success') { ?>
                  <a class="hotel_cancel" href="<?php echo site_url(); ?>b2c/cancel_voucher_confirm?voucherId=<?php echo $book_details->uniqueRefNo ?>&bookRefId=<?php echo $book_details->Booking_RefNo?>&callbackId=<?php echo base64_encode('hotel_crs') ?>">Confirm Cancel</a>
                  <?php } ?>
                </td>
              </tr>
              <?php } ?>
