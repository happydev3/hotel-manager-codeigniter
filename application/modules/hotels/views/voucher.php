          ...
          <div id="printArea">
            ...
            <div>
              <table width="50%" style="background: #428bca12">
                ...
                <tr>       
                  <td style="padding:8px;padding-bottom:5px;font-size:20px;color:#1a00aa;">TOTAL PRICE : US$ <?php echo number_format(($hotel_booking_info->total_cost + $hotel_booking_info->government_tax +$hotel_booking_info->service_tax +$hotel_booking_info->resort_fee-$hotel_booking_info->discount),2) ?></b></td>
                  <tr>       
