...
<div class="content white-container">
  ...
  <section id="hotel-details-section" class="push-top-20 hotel-details-section">
    <div class="container">
      <div class="row no-padding">
        ...
        <div class="col-md-5">
          ...
          <div class="price-details">
            <h2 class="price-tag">
              <small>from </small>
              <i class="fa fa-dollar"></i><span><?php echo ($hotelDetails->total_cost/$search_data['nights']); ?></span>
              <small>USD</small>
      ...
      <div class="white-box row2" style="margin-top: 30px;background: #ddd;">
        <div class="row">
      ...
      <div class="push-top-20 detail-content row2">
        <div id="htl-rooms" class="room-details row2">
          <h3 class="accordions-heading">Rooms &amp; Rates <small>(2 nights: 12/18/2017 - 12/20/2017)<!--  <a href="javascript:;" class="blue-link modifySearch">Change Dates</a></small> <span class="fa fa-angle-down pull-right"></span> --></h3>
          <div class="accordions-content">
            <div id="reservation-form" class="change-rooms" style="display: block;">
              <form action="<?php echo site_url().'/hotels/hotelroomdetails/'.base64_encode($hotelDetails->session_id.'/'.$refNo.'/'.$hotelDetails->search_id.'/'.$hotelDetails->hotel_code.'/'. base64_encode('hotel_crs')); ?>" class="tab-pane form-inline active"  method="post" name="reservationform">
                <div class="row no-padding">
                  <div class="col-sm-2">
                    <div class="form-group">
                      <label for="dpr1">Check-In</label>
                      <input name="departDate" type="text" value="" class="form-control" placeholder="Check-In" id="dpr1" autocomplete="off">
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="row no-padding">
                      <div class="col-md-9">
                        <div class="form-group">
                          <label for="dpr2">Check-Out</label>
                          <input name="returnDate" type="text" value="" class="form-control" placeholder="Check-Out"  id="dpr2" autocomplete="off">
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group">
                          <label class="invisible">2 Night</label>
                          <input name="night" type="text" value="1 Night" class="form-control" autocomplete="off" style="background: transparent;border: none;box-shadow: none;cursor: default;padding: 0;margin: 0;text-align: center;" readonly="">
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div id="htl-nearby" class="row2">
          ...
          <div class="white-box accordions-content nearby grid-view">
            <?php if(!empty($similar_data)) { ?>
            <?php for($s=0;$s<count($similar_data);$s++){ ?>
            <div class="result-grid hotel-grid result-box">
              <div class="row left-section">
                <div class="col-sm-12">
                  <div class="htl-img">
                    <img src="<?php echo base_url().'supplier/'.$similar_data[$s]->hotimage ?>" alt="<?php echo $similar_data[$s]->hotel_name ?>" class="img-responsive" />
                  </div>
                </div>
              </div>
            ...
            <!-- <div class="result-grid hotel-grid result-box">
              <div class="row left-section">
                <div class="col-sm-12">
                  <div class="htl-img">
                    <img src="<?php echo base_url() ?>public/images/hotel4.jpg" alt="" class="img-responsive" />
                  </div>
                </div>
              </div>
              <div class="row no-padding right-section">
                <div class="col-sm-12">
                  <div class="grid-content">
                    <div class="row2 result-details">
                      <h3>Place Station And Hotel Casino <span class="star star4"></span></h3>
                    </div>
                    <div class="row2">
                      <ul class="description">
                        <li><i class="fa fa-comments"></i> Okay, 5.5/10 <a href="javascript:;" class="rating ajax-tabs blue-link" data-id="rating"><u>51 Ratings</u></a></li>
