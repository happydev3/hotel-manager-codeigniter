<?php
   ...
   $cin = date('M d', strtotime(str_replace('/', '-', $checkIn)));
   $cout =date('M d', strtotime(str_replace('/', '-',  $checkOut))); 
   ...
   $nights=isset($search_data['nights'])?$search_data['nights']:'';  
    ...
    <div class="row">
      <div class="col-md-12">
        <ul class="breadcrumb">
          ...
          <li><a href="<?php  echo site_url().'hotels/results/'.base64_encode($ses_id.'/'.$refNo);?>"><?php echo $cityName;?> Hotels</a></li>
          <li class="active"><?php echo $hotelDetails->hotel_name; ?></li>
        </ul>
      </div>
    </div>
  </div>
...
<section id="" class="push-top-20">
 ...
 <div class="container">
    <div class="row">
      <div class="col-md-12">
        <ul class="search-details">
          <li><a href="<?php  echo site_url().'hotels/results/'.base64_encode($ses_id.'/'.$refNo);?>"><i class="fa fa-angle-left"></i> <u>All hotels in <?php echo $cityName;?></u></a></li>
          <li><?php echo $cin; ?> ~ <?php echo $cout; ?>, <?php echo $nights; ?> night(s), <?php echo $adults; ?> adults <?php if($childs>0){?> ,<?php echo $childs; ?> childs<?php } ?><?php if($infant==1){?> ,<?php echo $infant; ?> infant<?php } ?></li>
          <li><a href="javascript:;" class="btn btn-default modifySearch">Modify search <i class="fa fa-hand-o-down"></i></a></li>
        </ul>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <section id="reservation-form" class="reservation-color-form pos-inside-slide" style="display: none;margin-bottom: 0;">
          ...
          <form id="hotels-tab"  action="<?php echo site_url();?>/hotels/results" class="tab-pane form-inline active"  method="post" name="reservationform">
               <div class="col-sm-2">
                <div class="form-group">
                  ...
                  <input type="text" name="cityName" value="<?php echo $cityName;?>" class="form-control" id="destination2" placeholder="Enter Destination" autocomplete="off">
