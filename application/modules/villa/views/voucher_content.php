...
<div id="printArea">
		...
		<table width="100%" style="width: 100%">
			<tr>
				<td width="70%" style="padding: 15px 0;background: #4788c2;color: #fff;text-align: center;">
					<h3 style="margin: 0;font-size: 22px;margin-bottom: 5px">Thank you for booking with Vacaymenow <?php echo $passenger_info[0]->first_name ?> ! </h3>
				</td>
			</tr>
		</table>
	</div>
		...
		<table width="100%">
			<tr>
				<td style="padding: 8px;background: #fff;text-align: left;font-size: 20px;color:#1a00aa">
					<b><?php echo $result->villa_name; ?></b>
				</td>
			</tr>
			<tr>
				<td style="padding: 8px;"><?php echo $result->address.', '.$result->city; ?></td>
			</tr>
			<tr>
	...
	<div>
		<table width="100%" class="voucher_table">
			...
			<tr style="border-bottom: 1px solid #eee">
				...
				<td style="padding: 8px;text-align:center"><?php echo date('M d, Y',strtotime($result->check_in)); ?></td>
			</tr>
			<tr style="border-bottom: 1px solid #eee">
	...
	<div>
		<table width="50%" style="background: #428bca12">
			...
			<tr>
				<td style="padding: 8px;color:#1a00aa;"><b><?php echo $result->villa_name; ?></b></td>
			</tr>
			<tr>
	...
	<div>
		<table width="100%" class="voucher_table">
			...
			<tr style="border-bottom: 1px solid #eee">
				...
				<td style="padding: 8px;text-align:center"><?php echo $result->user_name; ?></td>
			</tr>
			<tr style="border-bottom: 1px solid #eee">
	...
	<div>
		<table class="clearfix" width="100%">
			<tr>
				<td width="17%" style="padding:8px;">For special requests or questions about the property, please call at <br/><b style="color:#e62d0f">Tel: <?php echo $result->phone; ?></b></td>
			</tr>
		</table>
	</div>
	<div>
