...
<div class="result-box villa-box htlResultRow searchhotel_box">
  <div class="row HotelInfoBox" id="sort" data-price="<?php echo $result[$i]->price; ?>" data-star="<?php echo $result[$i]->star_rating; ?>" data-hotel-name="<?php echo $result[$i]->property_name; ?>">
    <div class="col-sm-4 left-section">
      <div class="htl-img">
        ...
        <?php } ?>
        <div class="overlay">
          <?php for($s=0;$s<$result[$i]->star_rating;$s++){ ?>
        ...
        <div class="right-section">
          <div class="result-details ajax-div">
            <a href="<?php echo site_url(); ?>villa/villadetails/<?php echo base64_encode('VMNVILLASPACKAGECODE-'.$result[$i]->id); ?>">
              <h3><?php echo $result[$i]->property_name ?></h3>
            </a>
            <small><?php echo $result[$i]->address ?>, <?php echo $result[$i]->city_name ?> | <a href="javascript:;" class="maps ajax-tabs" data-id="map"><a href="javascript:;" class="maps ajax-tabs searchAjaxData" data-val="<?php echo $result[$i]->property_code ?>" data-type="maps" data-id="maps"><u>Map</u></a></a></small>
