...
$(function() {
  ...
  yatri.global = {
    ...
    init: function() {
      yatri.global.deviceSize();
      yatri.global.layout();
      yatri.global.animsition();
    },
    ...
    layout: function() {
      var defaultHeaderScheme = 'scheme-light',
          ...
          defaultColorScheme = 'amethyst-scheme-color',
          defaultHeaderPosition = 'header-fixed',
          defaultNavbarPosition = 'aside-fixed',
          defaultRightbarVisibility = 'rightbar-hidden',
          defaultAppClasses = 'scheme-default amethyst-scheme-color header-fixed aside-fixed rightbar-hidden';
  ...
  yatri.navbar = {
    ...
    init: function() {
      yatri.navbar.menu();
      yatri.navbar.ripple();
      yatri.navbar.removeRipple();
      yatri.navbar.collapse();
      yatri.navbar.offcanvas();
    },
  ...
  yatri.extra = {
    ...
    init: function() {
      yatri.extra.sparklineChart();
      yatri.extra.slimScroll();
      yatri.extra.daterangePicker();
      yatri.extra.easypiechart();
      yatri.extra.chosen();
      yatri.extra.toggleClass();
      yatri.extra.colorpicker();
      yatri.extra.touchspin();
      yatri.extra.datepicker();
      yatri.extra.animateProgress();
      yatri.extra.counter();
      yatri.extra.popover();
      yatri.extra.tooltip();
      yatri.extra.splash();
      yatri.extra.lightbox();
    },
  ...
  yatri.isMobile = {
    ...
    any: function() {
      return (yatri.isMobile.Android() || yatri.isMobile.BlackBerry() || yatri.isMobile.iOS() || yatri.isMobile.Opera() || yatri.isMobile.Windows());
    }
  };
  ...
  yatri.documentOnResize = {

		init: function(){

      var t = setTimeout( function(){

        yatri.documentOnReady.setSidebar();
        yatri.navbar.removeRipple();
  ...
  yatri.documentOnReady = {

		init: function(){
      yatri.global.init();
			yatri.header.init();
      yatri.navbar.init();
      yatri.documentOnReady.windowscroll();
      yatri.boxss.init();
      yatri.extra.init();
      yatri.documentOnReady.setSidebar();
		},
  ...
  // initializing
  $(document).ready( yatri.documentOnReady.init );
  $window.load( yatri.documentOnLoad.init );
  $window.on( 'resize', yatri.documentOnResize.init );
