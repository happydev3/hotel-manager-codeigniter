...
this.configDisplayScale();return this;};BaseGauge.prototype.configDisplayScale=function(){var backingStoreyatriRatio,deviceyatriRatio,height,prevDisplayScale,width;prevDisplayScale=this.displayScale;if(this.options.highDpiSupport===false){delete this.displayScale;}else{deviceyatriRatio=window.deviceyatriRatio||1;backingStoreyatriRatio=this.ctx.webkitBackingStoreyatriRatio||this.ctx.mozBackingStoreyatriRatio||this.ctx.msBackingStoreyatriRatio||this.ctx.oBackingStoreyatriRatio||this.ctx.backingStoreyatriRatio||1;this.displayScale=deviceyatriRatio/backingStoreyatriRatio;}
