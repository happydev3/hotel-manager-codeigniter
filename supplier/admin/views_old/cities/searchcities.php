...
<div class="contentpanel">
                              <legend class="control-label" for="focusedInput">Cities</legend>
                               <form id="form_hotel" method="post" action="<?php echo site_url();?>/hotelduplication/update_view">
                              <input type="text" class="form-control" id="hotelName"  placeholder="Enter City Name" name="city"  required /><br/>
