                ...
                <div class="content">
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <div class="box">
                                <div class="box-head">
                                    <h3>Pay to Supplier</h3>
                                </div>                        
                                <div class="box-content">
                                    <form action="<?php echo site_url(); ?>/supplier/billing_pay_supplier/<?php echo $supplier_id; ?>" method="post"  class='validate form-horizontal'>
                                        <input class="input-xlarge focused" id="" type="hidden" name="agent_no" value="<?php echo $supplier_id ?>" required>                                                              
