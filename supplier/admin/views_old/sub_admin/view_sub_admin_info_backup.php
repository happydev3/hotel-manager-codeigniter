...
<html lang="en">
                                                ...
                                                <div class="control-group warning">
                                                    ...
                                                    <div class="controls">
                                                        <div class="input-append">
                                                            ...
                                                            <a href="<?php echo site_url(); ?>/role/change_sub_admin_password/<?php echo $admin_info->admin_id; ?>" title="Click here to Reset Sub Admin password" data-rel="tooltip" class="btn btn-warning">Reset Password</a>
    ...
    <?php for ($i = 0; $i < count($country_list); $i++) { ?>
        <?php if ($admin_info->country == $country_list[$i]->name) { ?>
                                                     ...
                                                     <div class="control-group">
                                                <label for="selectError2" class="control-label">Modules</label>
                                                    <div class="controls">
                                                ...
                                                <div class="form-actions">
                                                    ...
                                                    <a href="<?php echo site_url(); ?>/role/sub_admin_manager" title="Click here to go back" data-rel="tooltip" class="btn btn-warning">Cancel</a>
                                                </div>
