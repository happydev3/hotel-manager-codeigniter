                        ...
                        <div class="span12">
                            <div class="box">
                                ...
                                <div class="box-content">
                                    <form class="form-horizontal" action="<?php echo site_url(); ?>/role/add_sub_Admin" enctype="multipart/form-data" method="post">
                                        <fieldset>
                                            ...
                                            <div class="control-group">
                                                <label for="selectError2" class="control-label">Modules</label>
                                                    <div class="controls">
                                                         <?php 
														 //echo "<pre/>";print_r($admin_models);
														 foreach ($admin_models as $mod) { ?>
                                                <table>
                                                    <tr>
                                                        <td>  <input type="checkbox" value="<?php echo $mod->sub_admin_module_id ?>" name="admin[]" > </td>
