...
<html lang="en">
    ...
    <body>
                            ...
                            <div class="box">
                                ...
                                <div class="box-content">
                                    <form action="<?php echo site_url(); ?>/distributor/deposit_amount/<?php echo $admin_id; ?>/" method="post"  enctype="multipart/form-data" class='validate form-horizontal'>
                                        <input class="input-xlarge focused" id="" type="hidden" name="admin_no" value="<?php echo $admin_info->admin_no; ?>" required disabled>                                                              
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
												<input type="text" class="input-xlarge focused"name="amount" value="<?php echo set_value('amount'); ?>" required>
                                            </div>
                                        </div>             
                                        <div class="control-group">
                                            <label for="pw3" class="control-label">Date of Deposit</label>
                                            <div class="controls">
												<input type="text" class="input-xlarge focused" id="deposit_date1" name="value_date" value="<?php echo set_value('deposit_date'); ?>" required>
                                            </div>
                                        </div>										
		...
		<script type="text/javascript">
			$(function(){
				var checkinDeposit = $('#deposit_date1').datepicker({
					minDate: '-12d',
					maxDate: '+12d',
					numberOfMonths: 2,
					dateFormat: 'mm/dd/yy',
