...
<head>
<meta charset="utf-8">
<title>:: View & Reply Message ::</title>
...
<div class="breadcrumbs">
	<div class="container-fluid">
		<ul class="bread pull-left">
			...
			<li>
				<a href="<?php echo site_url();?>/distributor/view_message/<?php echo $message_info->id;?>">
					View & Reply Message
				</a>
			</li>
		</ul>
						...
						<div class="box-content">
                         ...
                         <?php if (!empty($message_info) && $message_info->message_status != 'T') { ?>
                             	<li class="user2">
                    				...
                    				<form enctype="multipart/form-data" method="post" action="<?php echo site_url();?>/distributor/reply_message">
                            ...
                            <input type="hidden" value="<?php echo $message_info->id; ?>" name="msg_id">                  
                      		<input type="hidden" value="<?php echo $message_info->to_admin_id; ?>" name="to_admin_id">                          
