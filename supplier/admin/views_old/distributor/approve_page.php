                        ...
                        <div class="span12">
                            <div class="box">
                                ...
                                <div class="box-content">
                                    <form action="<?php echo site_url(); ?>/distributor/admin_approve_amount/<?php echo $acc_id ?>/<?php echo $admin_id ?>/" method="post"  enctype="multipart/form-data" class='validate form-horizontal'>
										...
										<?php }else{ ?>
										<div class="form-actions">
                                            <font style="color:red;">You do not sufficent balance to approve the amount, Request you recharge your account</font>
                                        </div>
										<?php } ?>
                                    </form>
                                </div>
