				...
				<div class="span12">
                  ...
                  <fieldset>
                      <tr> 
                        ...
                        <td>                                        
              <select id="selectError2" name="flight_gen_admin_no" required>
              ...
              <select id="selectError4" name="flight_gen_country" required>
                ...
                <br/><br/><br/>
						  ...
						  for($i=0;$i<count($distributor_markup_list);$i++) {?>
                             <?php if($distributor_markup_list[$i]->service_type == 2 && $distributor_markup_list[$i]->markup_type== 'generic') {?>
							<tr>
                                <td><?php echo $j+1;?></td>
                     ...
                     <?php } else { ?>
                                      ...
                                      <fieldset>
                                          ...
                                          <td class="center">Admin</td>
                                            <td>                                        
                                  <select id="selectError1" name="flight_spec_admin_no" required>
                                            <option value="all">ALL</option>
                                            <optgroup label="Admin List">                                       
                                            <?php
												for($i=0;$i<count($admin_list);$i++) {?>
                          ...
                          <?php $j=0;
						   for($i=0;$i<count($distributor_markup_list);$i++) {?>
                              <?php if($distributor_markup_list[$i]->service_type == 2 && $distributor_markup_list[$i]->markup_type== 'specific') {?>
							<tr>
                                <td><?php echo $j+1;?></td>
                                <td><?php echo $distributor_markup_list[$i]->admin_no;?></td>
                            	<td><?php echo $distributor_markup_list[$i]->api_name;?></td>
...
$(document).ready(function() {
	...
	$("#flight_generic").submit(function(ev){
		...
		$agent_no = $( "select[name='flight_gen_admin_no'] option:selected" ).val();
		...
		var dataString = "admin_no="+ $agent_no +"&service_type="+ $service_type +"&markup_type="+ $markup_type +"&api_name="+ $api_name +"&markup="+ $markup +"&country="+ $country;
		
		if(confirm('Are you sure you want to Add/Update Distributor Generic Flight MarkUp?')) {
			 ...
			 $.ajax({
				...
				success: function (data) {
					...
					window.location = '<?php echo site_url();?>/distributor/flight_markup_manager';
				}
	...
	$("#flight_specific").submit(function(ev){
		...
		$agent_no = $( "select[name='flight_spec_admin_no'] option:selected" ).val();
		...
		if(confirm('Are you sure you want to Add/Update Distributor Specific Flight MarkUp?')) {
