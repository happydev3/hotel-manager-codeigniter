						  ...
						  for($i=0;$i<count($b2c_markup_list);$i++) {?>
							...
							<tr>
								...
								<td class="center">
                                    ...
                                    <a class="btn btn-small manageB2CbusMarkupStatus" href="javascript:void(0);" title="Active" data-rel="tooltip" data-base-url="<?php echo site_url(); ?>" data-value="1" data-markup-id="<?php echo $b2c_markup_list[$i]->markup_id;?>" >
										<i class="icon-ok"></i>			                                          
									</a>
                                     <a class="btn btn-small manageB2CbusMarkupStatus" href="javascript:void(0);" title="Inactive" data-rel="tooltip" data-base-url="<?php echo site_url(); ?>" data-value="0" data-markup-id="<?php echo $b2c_markup_list[$i]->markup_id;?>" >
										<i class="icon icon-color icon-remove"></i>			                                          
									</a>
									<a class="btn btn-danger manageB2CbuMarkupStatus" href="javascript:void(0);" title="Delete" data-rel="tooltip" data-base-url="<?php echo site_url(); ?>" data-value="2" data-markup-id="<?php echo $b2c_markup_list[$i]->markup_id;?>" >
...
$(document).ready(function() {
	...
	$("#hotel_generic").submit(function(ev){
		...
		var dataString = "service_type="+ $service_type +"&markup_type="+ $markup_type +"&api_name="+ $api_name +"&markup="+ $markup +"&country="+ $country +"&process="+ $markup_process;
		alert(dataString);
		if(confirm('Are you sure you want to Add/Update B2C Generic Bus MarkUp?')) {
			 ...
			 $.ajax({
				...
				success: function (data) {
					//alert(data);
					window.location = '<?php echo site_url(); ?>/b2c/bus_markup_manager';
				}
	...
	$("#hotel_specific").submit(function(ev){
		...
		var dataString = "service_type="+ $service_type +"&markup_type="+ $markup_type +"&api_name="+ $api_name +"&markup="+ $markup +"&country="+ $country +"&process="+ $markup_process;
		alert(dataString);
		if(confirm('Are you sure you want to Add/Update B2C Specific bus MarkUp?')) {
