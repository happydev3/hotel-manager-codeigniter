...
$(document).ready(function() {
	...
	$("#hotel_generic").submit(function(ev){
		...
		if(confirm('Are you sure you want to Add/Update B2C Generic Apartment MarkUp?')) {
			 ...
			 $.ajax({
				...
				success: function (data) {
					//alert(data);
					window.location = '<?php echo site_url(); ?>/b2c/apart_markup_manager';
				}
	...
	$("#hotel_specific").submit(function(ev){
     ...
     $markup_process = $( "select[name='hotel_spec_markup_process']" ).val();		
		...
		if(confirm('Are you sure you want to Add/Update B2C Specific Apartment MarkUp?')) {
