			   ...
			   <div class="row-fluid sortable">
                        ...
                        <div class="row-fluid sortable">
                            <div class="box span12">
                              <legend class="control-label" for="focusedInput">Press Rooms</legend>
                                <div class="box-content">
                                  <form class="form-horizontal" action="<?php echo site_url(); ?>/cms/update_press_rooms/" enctype="multipart/form-data" method="post">
