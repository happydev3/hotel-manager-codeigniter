...
<div class="contentpanel">
                              ...
                              <legend class="control-label" for="focusedInput">Sky Planners Services</legend>
                                <div class="box-content">
                                    <form class="form-horizontal" action="<?php echo site_url(); ?>/cms/update_akbars_services" enctype="multipart/form-data" method="post">
