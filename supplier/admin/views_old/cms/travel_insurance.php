...
<div class="contentpanel">
                              ...
                              <legend class="control-label" for="focusedInput">Travel Insurance</legend>
                                <div class="box-content">
                                    <form class="form-horizontal" action="<?php echo site_url(); ?>/cms/update_travel_insurance" enctype="multipart/form-data" method="post">
