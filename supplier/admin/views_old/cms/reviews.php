...
<div class="contentpanel">
                              <legend class="control-label" for="focusedInput">Reviews</legend>
...
<ul class="nav nav-tabs nav-dark">
          ...
          <li class="active"><a href="#home2" data-toggle="tab"><strong>Reviews</strong></a></li>
                                                    ...
                                                    if (!empty($result)) { ?>
                                                        <?php for ($i = 0; $i < count($result); $i++) { ?>
                                                            <tr>
                                                                ...
                                                                <td class="center"><?php echo $result[$i]->Author; ?></td>
                                                                <td class="center"><?php echo $result[$i]->refno; ?></td>
																<td class="center"><?php echo $result[$i]->city; ?></td>
                                                         <td class="center">
                                ...
                                <?php if($result[$i]->status == 0) { ?>
                                 ...
                                 <?php } else if($result[$i]->status == 1) {?>

                                 <span class="label label-success">Active</span>

                                 <?php } else if($result[$i]->status == 2) { ?>
                                 ...
                                 <?php } ?>
                                    ...
                                    <a class="manageReviewStatus" href="javascript:void(0);" title="Active" data-rel="tooltip" data-base-url="<?php echo site_url();?>/" data-value="1" data-user-id="<?php echo $result[$i]->cms_id;?>" >

										<span class="glyphicon glyphicon-ok-sign"></span>

									</a>

                                     <a class="manageReviewStatus" href="javascript:void(0);" title="Inactive" data-rel="tooltip" data-base-url="<?php echo site_url();?>/" data-value="0" data-user-id="<?php echo $result[$i]->cms_id;?>" >

										<img alt="" src="<?php echo base_url();?>public/img/icons/fugue/busy.png">

									</a>

									<a class="manageReviewStatus" href="javascript:void(0);" title="Delete / Block" data-rel="tooltip" data-base-url="<?php echo site_url();?>/" data-value="2" data-user-id="<?php echo $result[$i]->cms_id;?>" >
...
$('.manageReviewStatus').live('click' , function(){
			...
			if(confirm('Are you sure you want to '+ $msg +' this User?')) {
			 $.ajax({
				url: $base_url+'cms/manage_review_status',
				type: "POST",
				data: "user_id="+ $user_id +"&status="+ $val,

				success: function (data) {
					window.location = $base_url + 'cms/reviews';
				}
			});
		}
	});
