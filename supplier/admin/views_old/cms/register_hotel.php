...
<div class="contentpanel">
		                               ...
		                               <legend class="control-label" for="focusedInput">Register your Hotel</legend>
                                <div class="box-content">
                                   <form class="form-horizontal" action="<?php echo site_url(); ?>/cms/update_register_hotel" enctype="multipart/form-data" method="post">
