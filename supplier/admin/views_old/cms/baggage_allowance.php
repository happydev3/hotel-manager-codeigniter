...
<div class="contentpanel">
                              ...
                              <legend class="control-label" for="focusedInput">Baggage Allowance</legend>
                                <div class="box-content">
                                    <form class="form-horizontal" action="<?php echo site_url(); ?>/cms/update_baggage_allowance" enctype="multipart/form-data" method="post">
