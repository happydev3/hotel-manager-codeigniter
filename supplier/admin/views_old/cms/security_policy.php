...
<div class="mainpanel">
  ...
  <div class="contentpanel">
    <legend class="control-label" for="focusedInput">Privacy Statement</legend>
    <div class="box-content">
      <form class="form-horizontal" action="<?php echo site_url(); ?>/cms/update_security_policy" enctype="multipart/form-data" method="post">
