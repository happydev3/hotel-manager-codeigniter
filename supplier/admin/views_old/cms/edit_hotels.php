...
<div class="contentpanel">
                              ...
                              <input type="text" class="form-control" id="hotelName"  placeholder="Enter City Name" name="cityName"  required />
                              <button id="submit" class="btn">Submit</button>
                              <br><br>
                              <form id="form_hotel" method="post" action="<?php echo site_url();?>/cms/update_hotel_name">
                              <input type="text" style="visibility: hidden"class="form-control" id="searchName"  placeholder="Enter Hotel Name" name="hotelName"  required />
                              <input type="hidden" name="id" value="">
                               <input type="hidden" name="api" value="">
                                <input type="hidden" name="adress" value="">
                              <button type="submit" style="visibility: hidden" id="update" >Update</button>
                              </form>
