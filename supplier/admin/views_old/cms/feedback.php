...
<div class="contentpanel">
                              ...
                              <legend class="control-label" for="focusedInput">Feed Back</legend>





								<form class="form-horizontal" action="<?php echo site_url(); ?>/cms/add_feedback" enctype="multipart/form-data" method="post">
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="col-sm-9" >
                                                    <textarea name="test" class="ckeditor"><?php if(isset($result->content) && $result->content!='')echo $result->content; ?></textarea>
                                                </div>
												</div>
											...
											<input class="form-control" type="text" name="Author" placeholder="Enter Athor Name" required=""/>
...
<ul class="nav nav-tabs nav-dark">
          ...
          <li class="active"><a href="#home2" data-toggle="tab"><strong>Feedback</strong></a></li>
                                                    ...
                                                    <?php if (!empty($result)) { ?>
                                                        <?php for ($i = 0; $i < count($result); $i++) { ?>
                                                            <tr>
																...
																<td class="center"><a href="<?php echo site_url(); ?>/cms/del_feedback/<?php echo $result[$i]->cms_id; ?>" onclick="return confirm('Do you raelly want to delete this testimonial')">Delete</a></td>
																</tr>
                                                        <?php } ?>
                                                    <?php } else { ?>
