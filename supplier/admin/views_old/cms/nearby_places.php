...
<div class="contentpanel">
                              ...
                              <legend class="control-label" for="focusedInput">Nearby Places</legend>
                                <div class="box-content">
                                    <form class="form-horizontal" action="<?php echo site_url(); ?>/cms/update_nearby_places" enctype="multipart/form-data" method="post">
