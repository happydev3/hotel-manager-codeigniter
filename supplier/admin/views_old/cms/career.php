...
<div class="contentpanel">
		                               ...
		                               <legend class="control-label" for="focusedInput">Careers</legend>
                                <div class="box-content">
                                   <form class="form-horizontal" action="<?php echo site_url(); ?>/cms/update_career" enctype="multipart/form-data" method="post">
