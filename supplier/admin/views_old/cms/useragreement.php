...
<div class="contentpanel">
                              <legend class="control-label" for="focusedInput">User Agreement</legend>
                                <div class="box-content">
                              <form class="form-horizontal" action="<?php echo site_url(); ?>/cms/update_useragreement" enctype="multipart/form-data" method="post">
