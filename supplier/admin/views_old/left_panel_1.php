<div class="leftpanel">
    <div class="logopanel">
        ...
        <div class="leftpanelinner">
            ...
            <li class="nav-parent <?php if(($this->router->fetch_class()=='role')&&($this->router->fetch_method()=='add_admin_user')) echo 'active';?>"><a href="#"><i class="fa fa-file-text"></i> <span>Role Manager</span></a>
            <ul class="children" <?php if(($this->router->fetch_class()=='role')&&($this->router->fetch_method()=='add_admin_user')||($this->router->fetch_method()=='admin_user_manager')) echo' style="display: block;"';?>>
...
<?php if (($this->session->userdata('admin_auth_9') != '') || ($this->session->userdata('role_id') == 1)) { ?>
<li class="nav-parent <?php if(($this->router->fetch_class()=='b2b')&&($this->router->fetch_method()=='agent_manager')||($this->router->fetch_method()=='create_agent')) echo 'active nav-active';?>">
    <a href="#"><i class="fa fa-file-text"></i> <span>B2B User Management</span></a>
...
<?php } ?>
<?php if (($this->session->userdata('admin_auth_2') != '') || ($this->session->userdata('role_id') == 1)) { ?>
...
<?php } ?>
<?php if (($this->session->userdata('admin_auth_3') != '') || ($this->session->userdata('role_id') == 1)) { ?>
<li class="nav-parent <?php if(($this->router->fetch_class()=='b2b')&&($this->router->fetch_method()=='b2b_reports_manager_flights')||($this->router->fetch_method()=='b2b_reports_manager_bus')||($this->router->fetch_method()=='b2b_reports_manager_hotel')) echo 'active nav-active';?>"><a href="#"><i class="fa fa-file-text"></i> <span>B2B Reports Manager</span></a>
<ul class="children" <?php if(($this->router->fetch_class()=='b2b')&&($this->router->fetch_method()=='b2b_reports_manager_flights')||($this->router->fetch_method()=='b2b_reports_manager_bus')||($this->router->fetch_method()=='b2b_reports_manager_hotel')) echo' style="display: block;"';?>>
<li class="<?php if($this->router->fetch_method()=='b2b_reports_manager_hotel') echo 'active';?>">
    ...
    <li class="<?php if($this->router->fetch_method()=='b2b_reports_manager_flights') echo 'active';?>"><a href="<?php echo site_url(); ?>/b2b/b2b_reports_manager_flights"><i class="fa fa-caret-right"></i>  B2B Flights</a></li>
    <li class="<?php if($this->router->fetch_method()=='b2b_reports_manager_holiday') echo 'active';?>"><a href="<?php echo site_url(); ?>/b2b/b2b_reports_manager_holiday"><i class="fa fa-caret-right"></i>  B2B Holiday </a>
</li> 
<li class="<?php if($this->router->fetch_method()=='b2b_reports_manager_bus') echo 'active';?>"><a href="<?php echo site_url(); ?>/b2b/b2b_reports_manager_bus"><i class="fa fa-caret-right"></i>  B2B Bus </a>
</li>
</ul>
</li>
<?php } ?>
<?php if (($this->session->userdata('admin_auth_4') != '') || ($this->session->userdata('role_id') == 1)) { ?>
...
<?php } ?>
<?php if (($this->session->userdata('admin_auth_5') != '') || ($this->session->userdata('role_id') == 1)) { ?>
...
<li class="<?php if($this->router->fetch_method()=='flight_markup_manager') echo 'active';?>">
<a href="<?php echo site_url(); ?>/b2c/flight_markup_manager">
<i class="fa fa-caret-right"></i>  Flight Markup Manager
</a>
</li>
</ul>
...
<?php } ?>
<?php if (($this->session->userdata('admin_auth_6') != '') || ($this->session->userdata('role_id') == 1)) { ?>
<li class="nav-parent <?php if(($this->router->fetch_class()=='b2c')&&($this->router->fetch_method()=='b2c_reports_manager_flights')||($this->router->fetch_method()=='b2c_reports_manager_bus')||($this->router->fetch_method()=='b2c_reports_manager_hotel')) echo 'active nav-active';?>"><a href="#"><i class="fa fa-file-text"></i> <span>B2C Reports Manager</span></a>
<ul class="children" <?php if(($this->router->fetch_class()=='b2c')&&($this->router->fetch_method()=='b2c_reports_manager_flights')||($this->router->fetch_method()=='b2c_reports_manager_bus')||($this->router->fetch_method()=='b2c_reports_manager_hotel')) echo' style="display: block;"';?>>
...
<li class="<?php if($this->router->fetch_method()=='b2c_reports_manager_flights') echo 'active';?>"><a href="<?php echo site_url(); ?>/b2c/b2c_reports_manager_flights"><i class="fa fa-caret-right"></i>  B2C Flights</a></li>
...
<li class="<?php if($this->router->fetch_method()=='b2c_reports_manager_bus') echo 'active';?>"><a href="<?php echo site_url(); ?>/b2c/b2c_reports_manager_bus"><i class="fa fa-caret-right"></i>  B2C Bus </a>
</li>
</ul>
</li>
<?php } ?>
<?php if (($this->session->userdata('admin_auth_7') != '') || ($this->session->userdata('role_id') == 1)) { ?>
<li class="nav-parent"><a href="#"><i class="fa fa-file-text"></i> <span>Discount Manager</span></a>
<ul class="children">
<li class="<?php if($this->router->fetch_method()=='b2c_disocunt_manager') echo 'active';?>">
<a href="<?php echo site_url(); ?>/b2c/flight_discount_manager"><i class="fa fa-caret-right"></i> B2C Flights Discount Manager </a></li>
<li class="<?php if($this->router->fetch_method()=='b2b_discount_manager') echo 'active';?>"><a href="<?php echo site_url(); ?>/b2b/flight_discount_manager"><i class="fa fa-caret-right"></i>B2B Discount Manager</a></li>
<li class="<?php if($this->router->fetch_method()=='b2c_reports_manager_holiday') echo 'active';?>"><a href="<?php echo site_url(); ?>/b2c/b2c_reports_manager_holiday"><i class="fa fa-caret-right"></i>  B2C Holiday </a>
</li> 
</ul>
</li>
<?php } ?>
<?php if (($this->session->userdata('admin_auth_8') != '') || ($this->session->userdata('role_id') == 1)) { ?>
<li class="nav-parent <?php if(($this->router->fetch_class()=='home')&&(($this->router->fetch_method()=='currency_manager')||($this->router->fetch_method()=='api_manager')||($this->router->fetch_method()=='promotion_manager')||($this->router->fetch_method()=='hotel_logs')||($this->router->fetch_method()=='api_logs'))||($this->router->fetch_method()=='payment_manager')  )echo 'active nav-active';?>"><a href="#"><i class="fa fa-file-text"></i> <span>My Control Panel</span></a>
<ul class="children" <?php if(($this->router->fetch_class()=='home')&&(($this->router->fetch_method()=='currency_manager')||($this->router->fetch_method()=='api_manager')||($this->router->fetch_method()=='promotion_manager')||($this->router->fetch_method()=='hotel_logs')||($this->router->fetch_method()=='api_logs'))||($this->router->fetch_method()=='payment_manager')  ) echo' style="display: block;"';?>>
...
<li class="<?php if($this->router->fetch_method()=='promotion_manager') echo 'active';?>">
<a href="<?php echo site_url(); ?>/home/promotion_manager">
<i class="fa fa-caret-right"></i>  Promotional Manager
</a>
</li>
...
<li class="<?php if($this->router->fetch_method()=='api_logs') echo 'active';?>">
<a href="<?php echo site_url(); ?>/home/api_logs">
<i class="fa fa-caret-right"></i>   API Logs
</a>
</li>
...
<i class="fa fa-caret-right"></i>Add Packages Category
</a></li>
...
<i class="fa fa-caret-right"></i> Add Itinery
</a></li>
...
<li class="<?php if($this->router->fetch_method()=='paxlist') echo 'active';?>"><a href="<?php echo site_url('holiday/pax_types'); ?>">
<i class="fa fa-caret-right"></i> Pax Type
</a></li>
<li class="<?php if($this->router->fetch_method()=='packagetype') echo 'active';?>"><a href="<?php echo site_url('holiday/package_types'); ?>">
<i class="fa fa-caret-right"></i> Packages Type
</a></li>
<li class="<?php if($this->router->fetch_method()=='packagetype') echo 'active';?>"><a href="<?php echo site_url('holiday/add_rail_cost'); ?>">
<i class="fa fa-caret-right"></i> Rail Cost
</a></li>
...
<!--     <li class="<?php if($this->router->fetch_method()=='awards') echo 'active';?>"><a href="<?php echo site_url(); ?>/cms/awards"><i class="fa fa-caret-right"></i> Awards</a></li> -->
<li class="<?php if($this->router->fetch_method()=='career') echo 'active';?>"><a href="<?php echo site_url(); ?>/cms/career"><i class="fa fa-caret-right"></i>Careers</a></li>
<li class="<?php if($this->router->fetch_method()=='contact_us') echo 'active';?>"><a href="<?php echo site_url(); ?>/cms/contact_us"><i class="fa fa-caret-right"></i> Contact us</a></li>
<li class="<?php if($this->router->fetch_method()=='testimonials') echo 'active';?>"><a href="<?php echo site_url(); ?>/cms/testimonials"><i class="fa fa-caret-right"></i>Testimonials</a></li>
<!--     <li class="<?php if($this->router->fetch_method()=='foreign_exchange') echo 'active';?>"><a href="<?php echo site_url(); ?>/cms/foreign_exchange"><i class="fa fa-caret-right"></i>Foreign-Exchange</a></li>
<li class="<?php if($this->router->fetch_method()=='cheques') echo 'active';?>"><a href="<?php echo site_url(); ?>/cms/cheques"><i class="fa fa-caret-right"></i>Travellers Cheques</a></li>
<li class="<?php if($this->router->fetch_method()=='currency_notes') echo 'active';?>"><a href="<?php echo site_url(); ?>/cms/currency_notes"><i class="fa fa-caret-right"></i>Currency Notes</a></li>
<li class="<?php if($this->router->fetch_method()=='multicurrency') echo 'active';?>"><a href="<?php echo site_url(); ?>/cms/multicurrency"><i class="fa fa-caret-right"></i>My Global Multicurrency Forex Card</a></li>
<li class="<?php if($this->router->fetch_method()=='commission') echo 'active';?>"><a href="<?php echo site_url(); ?>/cms/commission"><i class="fa fa-caret-right"></i>Commission Free Foreign Exchange</a></li>
<li class="<?php if($this->router->fetch_method()=='disclaimer') echo 'active';?>"><a href="<?php echo site_url(); ?>/cms/disclaimer"><i class="fa fa-caret-right"></i>Disclaimer</a></li> -->
<li class="<?php if($this->router->fetch_method()=='privacy_statement') echo 'active';?>"><a href="<?php echo site_url(); ?>/cms/privacy_statement"><i class="fa fa-caret-right"></i>Privacy Policy</a></li>
<li class="<?php if($this->router->fetch_method()=='terms_condition') echo 'active';?>"><a href="<?php echo site_url(); ?>/cms/terms_condition"><i class="fa fa-caret-right"></i>Terms & Condition</a></li>
<li class="<?php if($this->router->fetch_method()=='security_policy') echo 'active';?>"><a href="<?php echo site_url(); ?>/cms/security_policy"><i class="fa fa-caret-right"></i>Security Policy</a></li>
<li class="<?php if($this->router->fetch_method()=='fare_rules') echo 'active';?>"><a href="<?php echo site_url(); ?>/cms/fare_rules"><i class="fa fa-caret-right"></i>Fare Rules</a></li>
<li class="<?php if($this->router->fetch_method()=='akbars_services') echo 'active';?>"><a href="<?php echo site_url(); ?>/cms/akbars_services"><i class="fa fa-caret-right"></i>Sky Planners Services</a></li>
<li class="<?php if($this->router->fetch_method()=='useragreement') echo 'active';?>"><a href="<?php echo site_url(); ?>/cms/useragreement"><i class="fa fa-caret-right"></i>User Agreement</a></li>
<li class="<?php if($this->router->fetch_method()=='why_akbars') echo 'active';?>"><a href="<?php echo site_url(); ?>/cms/why_akbars"><i class="fa fa-caret-right"></i>Why Sky Planners</a></li>
<li class="<?php if($this->router->fetch_method()=='baggage_allowance') echo 'active';?>"><a href="<?php echo site_url(); ?>/cms/baggage_allowance"><i class="fa fa-caret-right"></i>Baggage Allowance</a></li>
<li class="<?php if($this->router->fetch_method()=='nearby_places') echo 'active';?>"><a href="<?php echo site_url(); ?>/cms/nearby_places"><i class="fa fa-caret-right"></i>Nearby Places</a></li>
<li class="<?php if($this->router->fetch_method()=='travel_insurance') echo 'active';?>"><a href="<?php echo site_url(); ?>/cms/travel_insurance"><i class="fa fa-caret-right"></i>Travel Insurance</a></li>
<li class="<?php if($this->router->fetch_method()=='travel_tips') echo 'active';?>"><a href="<?php echo site_url(); ?>/cms/travel_tips"><i class="fa fa-caret-right"></i>Travel Tips</a></li>
</ul>
</li>
<?php } ?>
<!--    <?php if ($this->admin_auth->is_admin()) { ?>
<li class="nav-parent <?php if($this->router->fetch_class()=='cms') echo 'active nav-active';?>"><a href="#"><i class="fa fa-file-text"></i> <span> Branch Details</span></a>
<ul class="children" <?php if($this->router->fetch_class()=='cms') echo' style="display: block;"';?>>
<li class="<?php if($this->router->fetch_method()=='branch_details') echo 'active';?>"><a href="<?php echo site_url(); ?>/cms/branch_details"><i class="fa fa-caret-right"></i> <span>Add Branch Details</span></a></li>
<li class="<?php if($this->router->fetch_method()=='branch_view') echo 'active';?>"><a href="<?php echo site_url(); ?>/cms/branch_view"><i class="fa fa-caret-right"></i> <span>View Branch Details</span></a></li>
