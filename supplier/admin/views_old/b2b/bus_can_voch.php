...
<div class="col-md-8">
<table border="1px"><tr><th colspan="2" style="text-align:center">akbars Bus Cancellation Voucher</th></tr>
...
<tr><th>Sub Total</th><th><?php  echo round($booking_details[$i]->total_fare); ?></th></tr>
<tr><th>Tax Amount</th><th>INR   <?php  echo round($booking_details[$i]->site_tax); ?></th></tr>
<tr><th>Total Amount</th><th><?php  echo round($booking_details[$i]->total_fare); ?></th></tr>
...
<tr><th>Cancellation Fee Of XML</th><th>INR  <?php  echo $booking_details[$i]->cancellation_charge; ?></th></tr>
