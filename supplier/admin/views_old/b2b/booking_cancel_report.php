           ...
           <div class="row-fluid">
						...
						<!--	<td><?php 	//if($hotel_booking_summary[$i]->agent_id!=0){
										...
										//echo $agentno->agent_no;
													...
													<td>
																...
																<a target="_blank"  href="<?php echo preg_replace('/\/admin/','',site_url()); ?>hotels/agent_voucher_invoice?voucherId=<?php echo $hotel_booking_summary[$i]->uniqueRefNo; ?>&hotelRefId=<?php echo $hotel_booking_summary[$i]->Booking_RefNo; ?>">Invoice</a>
															</td>
														<td>
							...
							<td><a target="_blank"  href="<?php echo preg_replace('/\/admin/','',site_url()); ?>hotels/credit_note_hotel?voucherId=<?php echo $hotel_booking_summary[$i]->uniqueRefNo; ?>&hotelRefId=<?php echo $hotel_booking_summary[$i]->Booking_RefNo; ?>">Voucher</a></td>	
									<td><form action="<?php echo site_url(); ?>/b2c/update_B2B_hotel_ref_amt/<?php echo $hotel_booking_summary[$i]->uniqueRefNo; ?>" method="POST"><input type="text" name="refund_amt" value="<?php echo $hotel_booking_summary[$i]->Conv_Refund_Amt ?>"/><input type="submit" value="Update"/></form></td>
                                                        </tr>
                                                     <?php } ?>
                                                <?php } else { ?>
                                                <div class="alert alert-block alert-danger">
			...
			<div><input type="button" id="export_excel_button" class="btn btn-success btn btn-primary pull-right" value="Download Excel"/></div>
													...
													<td><?php echo $flight_booking_summary[$i]->CurrencyCode.'&nbsp'. $flight_booking_summary[$i]->NetRate; ?></td>				
														...
														<td>
															...
															<td>
																...
																<a target="_blank" href="<?php echo  site_url(); ?>/b2b/agent_flight_invoice/<?php echo $flight_booking_summary[$i]->uniqueRefNo; ?>/<?php  if(!empty($RefIDs)) { echo implode('/',$RefIDs); } else { echo ''; }	; ?>">E-Ticket</a>
															</td>
															<td>
																<?php $RefIDs = array_filter(explode(',',$flight_booking_summary[$i]->BookingRefId)); ?>
								 ...
								 <td><?php echo $flight_booking_summary[$i]->Cancellation_api_Charge ?></td>
								  ...
								  <td><?php echo $flight_booking_summary[$i]->Refund_Amt ?></td>
								...
								<td><form action="<?php echo site_url(); ?>/b2c/update_B2B_flights_ref_amt/<?php echo $flight_booking_summary[$i]->uniqueRefNo; ?>" method="POST"><input type="text" name="refund_amt" value="<?php echo $flight_booking_summary[$i]->Conv_Refund_Amt ?>"/><input type="submit" value="Update"/></form></td>							
							 ...
							 <?php  if($vale == 3){ ?>
								...
								<td>Refund Invoice button</td>
								<td><form action="<?php echo site_url(); ?>/b2c/update_B2B_bus_ref_amt/<?php echo $bus_booking_summary[$i]->uniqueRefNo; ?>" method="POST"><input type="text" name="refund_amt" value="<?php echo $bus_booking_summary[$i]->Refund_Amt ?>"/><input type="submit" value="Update"/></form></td>
													</tr>
												<?php } ?>
											<?php }  else { ?>
					...
					<?php } ?>
						...
						<!--	<td><?php 	//if($apartment_booking_summary[$i]->agent_id!=0){
							...
							<td><a target="_blank"  href="<?php echo preg_replace('/\/admin/','',site_url()); ?>hotels/voucher_cancel?voucherId=<?php echo $apartment_booking_summary[$i]->uniqueRefNo; ?>&hotelRefId=<?php echo $apartment_booking_summary[$i]->Booking_RefNo; ?>">Voucher</a></td>
								<td>Refund Invoice button</td>
								<td><form action="<?php echo site_url(); ?>/b2c/update_B2B_apart_ref_amt/<?php echo $apartment_booking_summary[$i]->uniqueRefNo; ?>" method="POST"><input type="text" name="refund_amt" value="<?php echo $apartment_booking_summary[$i]->Refund_Amt ?>"/><input type="submit" value="Update"/></form></td>
                                                        </tr>
                                                     <?php } ?>
                                                <?php } else { ?>
                                                <div class="alert alert-block alert-danger">
