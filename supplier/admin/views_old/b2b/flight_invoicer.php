...
<tr><th>Booked by</th><th><?php echo $passenger_info[$i]->first_name  ?></th></tr>
<tr><th>Address</th><th><?php echo $passenger_info[$i]->address  ?></th></tr>
<tr><th>Flight PNR No.</th><th><?php echo $booking_info[$i]->pnr  ?></th></tr>
<tr><th>Booking Reference Id</th><th><?php echo $booking_info[$i]->BookingReferenceId  ?></th></tr>
...
<?php if($booking_info[$i]->mode !='mode') { ?>
<tr><th>Return Date</th><th><?php $ret_time=explode('T',$booking_info[$i]->ArrivalDateTime);echo $ret_time1=date('d-m-y',strtotime($ret_time[0])) ?></th>	</tr>
<?php } ?>
</table>
<?php   } }?>
...
<tr><th>Sector Details : Flight Name (Number) </th><th><?php echo $booking_info[$i]->MarketingAirline_Name  ?>(<?php echo $booking_info[$i]->FlightNumber  ?>)</th></tr>
...
<tr><th>Discount/Comission </th><th><?php echo $booking_info[$i]->Agent_discount  ?></th></tr>
<tr><th>Cashback</th><th><?php //echo $booking_info[$i]->uniqueRefNo  ?></th></tr>
