                            ...
                            <div class="box">
                                ...
                                <div class="box-content box-nomargin">
                                    <div class="tab-content">
                                       <form method="Get" action="<?php echo site_url(); ?>home/view_flights_page/">
                                                    ...
                                                    <?php if (!empty($flight_query_summary)) { ?>
                                                        <?php for ($i = 0; $i < count($flight_query_summary); $i++) { ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo $flight_query_summary[$i]->user_city; ?></td>
                                                                <td><?php echo $flight_query_summary[$i]->depatarture; ?></td>
                                                                <td><?php echo $flight_query_summary[$i]->dest; ?></td>
                                                                <td><?php echo $flight_query_summary[$i]->tourtype; ?></td>
																<td><?php echo $flight_query_summary[$i]->tickettype; ?></td>
																
                                                                <td><?php echo $flight_query_summary[$i]->depart; ?></td>
                                                                <td><?php echo $flight_query_summary[$i]->return1; ?></td>
                                                                ...
                                                                <td><?php echo $flight_query_summary[$i]->class_travel; ?></td>
