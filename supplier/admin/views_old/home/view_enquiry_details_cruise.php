...
<form method="Get" action="<?php echo site_url(); ?>home/view_cruise_page/">
                                                    ...
                                                    <?php if (!empty($flight_query_summary)) { ?>
                                                        <?php for ($i = 0; $i < count($flight_query_summary); $i++) { ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo date('d-m-y',strtotime($flight_query_summary[$i]->dpc1)); ?></td>
                                                              <td><?php echo date('d-m-y',strtotime($flight_query_summary[$i]->return1)); ?></td>
                                                                ...
                                                                <td><?php echo $flight_query_summary[$i]->noCabin; ?></td>
																<td><?php echo $flight_query_summary[$i]->cabintype; ?></td>
