                            ...
                            <div class="box">
                                ...
                                <div class="box-content box-nomargin">
                                    <div class="tab-content">
                                       <form method="Get" action="<?php echo site_url(); ?>home/view_mice_page/">
                                                    ...
                                                    <?php if (!empty($flight_query_summary)) { ?>
                                                        <?php for ($i = 0; $i < count($flight_query_summary); $i++) { ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo $flight_query_summary[$i]->Looking; ?></td>
                                                                <td><?php echo $flight_query_summary[$i]->dest; ?></td>
                                                              <td><?php echo $flight_query_summary[$i]->dpm; ?></td>
                                                              
                                                                <td><?php echo $flight_query_summary[$i]->no_ofdays; ?></td>
                                                                <td><?php echo $flight_query_summary[$i]->noDelegates; ?></td>
