              ...
              <select id="selectError4" name="hotel_gen_country" required>
                ...
                <br/><br/><br/>
						  ...
						  for($i=0;$i<count($canc_markup_list);$i++) {?>
                             <?php if($canc_markup_list[$i]->service_type == 1 && $canc_markup_list[$i]->markup_type== 'generic') {?>
							<tr>
                                <td><?php echo $j+1;?></td>
...
$(document).ready(function() {
	...
	$("#hotel_generic").submit(function(ev){
		...
		if(confirm('Are you sure you want to Add/Update  Hotel Cancellation MarkUp?')) {
			 ...
			 $.ajax({
				...
				success: function (data) {
					//alert(data);
					window.location = '<?php echo site_url();?>/home/canc_markup_manager';
				}
