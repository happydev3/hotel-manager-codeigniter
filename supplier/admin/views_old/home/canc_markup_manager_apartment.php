              ...
              <select id="selectError4" name="hotel_gen_country" required>
                ...
                <br/><br/><br/>
						  ...
						  for($i=0;$i<count($canc_markup_list);$i++) {?>
                             <?php if($canc_markup_list[$i]->service_type == 5 && $canc_markup_list[$i]->markup_type== 'generic') {?>
							<tr>
                                <td><?php echo $j+1;?></td>
							...
							<!--	<td class="center">
								...
								<td class="center">
                                    ...
                                    <a class="btn btn-small manageB2CHotelMarkupStatus" href="javascript:void(0);" title="Active" data-rel="tooltip" data-base-url="<?php echo site_url();?>/" data-value="1" data-markup-id="<?php echo $canc_markup_list[$i]->markup_id;?>" >
										<i class="icon-ok"></i>			                                          
									</a>
                                     <a class="btn btn-small manageB2CHotelMarkupStatus" href="javascript:void(0);" title="Inactive" data-rel="tooltip" data-base-url="<?php echo site_url();?>/" data-value="0" data-markup-id="<?php echo $canc_markup_list[$i]->markup_id;?>" >
										<i class="icon icon-color icon-remove"></i>			                                          
									</a>
									<a class="btn btn-danger manageB2CHotelMarkupStatus" href="javascript:void(0);" title="Delete" data-rel="tooltip" data-base-url="<?php echo site_url();?>/" data-value="2" data-markup-id="<?php echo $canc_markup_list[$i]->markup_id;?>" >
...
$(document).ready(function() {
	...
	$("#hotel_generic").submit(function(ev){
		...
		if(confirm('Are you sure you want to Add/Update  Apartment Cancellation MarkUp?')) {
			 ...
			 $.ajax({
				...
				success: function (data) {
					//alert(data);
					window.location = '<?php echo site_url();?>/home/canc_markup_manager_apartment';
				}
