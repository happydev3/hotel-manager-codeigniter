...
<form method="Get" action="<?php echo site_url(); ?>home/view_visa_page/">
                                                    ...
                                                    <?php if (!empty($flight_query_summary)) { ?>
                                                        <?php for ($i = 0; $i < count($flight_query_summary); $i++) { ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo $flight_query_summary[$i]->dob1; ?></td>
																 	<td><?php echo date('y-m-d',strtotime($flight_query_summary[$i]->booking_date)); ?></td>
																
                                                                <td><?php echo $flight_query_summary[$i]->cty; ?></td>
                                                                <td><?php echo $flight_query_summary[$i]->visacate; ?></td>
                                                              <td><?php echo $flight_query_summary[$i]->wantogo; ?></td>
                                                              
                                                                <td><?php echo $flight_query_summary[$i]->pass_num; ?></td>
