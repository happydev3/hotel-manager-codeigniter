...
<form method="Get" action="<?php echo site_url(); ?>home/view_corporate_page/">
                                                    ...
                                                    <?php if (!empty($flight_query_summary)) { ?>
                                                        <?php for ($i = 0; $i < count($flight_query_summary); $i++) { ?>
                                                            <tr>
																...
																<td><?php echo $flight_query_summary[$i]->Address; ?></td>
																
                                                                <td><?php echo $flight_query_summary[$i]->Organisation ?></td>
																<td><?php echo $flight_query_summary[$i]->cty; ?></td>
																<td><?php echo date('y-m-d',strtotime($flight_query_summary[$i]->booking_date)); ?></td>
																
                                                                <td><?php echo $flight_query_summary[$i]->State; ?></td>
                                                                <td><?php echo $flight_query_summary[$i]->Postcode; ?></td>
                                                              <td><?php echo $flight_query_summary[$i]->book_type; ?></td>
                                                              <td><?php echo $flight_query_summary[$i]->dest; ?></td>
                                                              <td><?php echo $flight_query_summary[$i]->dpcp; ?></td>
                                                              
                                                                <td><?php echo $flight_query_summary[$i]->no_ofDelegates; ?></td>
