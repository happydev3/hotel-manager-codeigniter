                            ...
                            <div class="box">
                                ...
                                <div class="box-content box-nomargin">
                                    <div class="tab-content">
                                       <form method="Get" action="<?php echo site_url(); ?>home/view_insurance_page/">
                                                    ...
                                                    <?php if (!empty($flight_query_summary)) { ?>
                                                        <?php for ($i = 0; $i < count($flight_query_summary); $i++) { ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo $flight_query_summary[$i]->dobd.'-'.$flight_query_summary[$i]->dobm.'-'.$flight_query_summary[$i]->doby; ?></td>
																<td><?php echo $flight_query_summary[$i]->cty; ?></td>
																<td><?php echo date('y-m-d',strtotime($flight_query_summary[$i]->booking_date)); ?></td>
																
                                                                <td><?php echo $flight_query_summary[$i]->Coverage; ?></td>
                                                                <td><?php echo $flight_query_summary[$i]->Travelling; ?></td>
                                                              <td><?php echo $flight_query_summary[$i]->Insurance; ?></td>
                                                              <td><?php echo $flight_query_summary[$i]->startdate; ?></td>
                                                              <td><?php echo $flight_query_summary[$i]->enddate; ?></td>
                                                              
                                                                <td><?php echo $flight_query_summary[$i]->no_ofdays; ?></td>
