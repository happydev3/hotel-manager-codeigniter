...
?>
        ...
        <div class="tab-content">
          <form action="<?php echo site_url() ?>activity/update_all" method="post" class="step_form step1" steps="1" name="step1" role="form">
              ...
              <div class="row border_row">
                <div class="form-group col-md-4">
                  ...
                  <div class="check_icon">
                    <label class="checkbox-inline radio-custom2 radio-custom2-sm"><input type="radio" name="activity_type" value="Private" <?php if($package_info->activity_type =='Private') echo 'checked="checked"'; ?>><i></i> Private</label>
                    <label class="checkbox-inline radio-custom2 radio-custom2-sm"><input type="radio" name="activity_type" value="Scheduled" <?php if($package_info->activity_type =='Scheduled') echo 'checked="checked"'; ?>><i></i> Scheduled <div class="backets_info">(SIC)</div></label>
                  </div>
                </div>
                <div class="form-group col-md-4">
                  <label class="strong" for="activity_name">Activity Name :</label>
                  <input name="activity_name" value="<?php echo $package_info->activity_name ?>" id="activity_name" type="text" class="form-control" required>
                </div>
                <div class="form-group col-md-4">
                  <label class="strong" for="activity_code">Activity Code :</label>
                  <input type="text" name="activity_code" value="<?php echo $package_info->activity_code ?>" id="activity_code" class="form-control" readonly required>
                </div>
              </div>
              <div class="row border_row">
                ...
                <div class="form-group col-md-4">
                  ...
                  <select name="city_covering[]" id="city_covering" class="select2_multiple form-control" multiple="multiple" required="">
                    <?php foreach($city_cover as $cc){ ?>
                      <option value="<?php echo $cc; ?>" selected><?php foreach($activity_city as $cii){if($cii->city_id==$cc)echo $cii->city_name;} ?></option>
                    <?php } ?>
...
$(document).ready(function() {
  ...
  $eventSelect.on("select2:select select2:unselect", function (e) {
      ...
      $.ajax({
        type: 'post',
        url: '<?php echo site_url(); ?>activity/update_route/'+$pack_id,
