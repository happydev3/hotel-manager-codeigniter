        ...
        <div class="col-md-12">
          <section class="boxs">
            ...
            <div class="boxs-body">
              ...
              <form action="<?php echo site_url(); ?>contract/update_contract" method="post" class="" role="form" enctype="multipart/form-data" data-parsley-validate>
                ...
                <div class="row border_row">
                  <div class="form-group col-md-3">
                    ...
                    <input type="text" name="bank_name" value="<?php echo $contract_info->bank_name ?>" id="bank_name" class="form-control" required>
                  </div>
                  <div class="form-group col-md-3">
                    <label for="branch_name"><strong>Branch Name:</strong></label>
                    <input type="text" name="branch_name" value="<?php echo $contract_info->branch_name ?>" id="branch_name" class="form-control" required>
                  </div>
                  <div class="form-group col-md-3">
                    <label for="account_no"><strong>Account Number:</strong></label>
                    <input type="text" name="account_no" value="<?php echo $contract_info->account_no ?>" id="account_no" class="form-control" required>
                  </div>
                  <div class="form-group col-md-3">
                    <label for="ifsc_code"><strong>IFSC Code:</strong></label>
                    <input type="text" name="ifsc_code" value="<?php echo $contract_info->ifsc_code ?>" id="ifsc_code" class="form-control" required>
                  </div>
                </div>
                <div class="row border_row">
                  <div class="form-group col-md-3">
                    <label for="rtgs_neft_code"><strong>RTGS / NEFT Code:</strong></label>
                    <input type="text" name="rtgs_neft_code" value="<?php echo $contract_info->rtgs_neft_code ?>" id="rtgs_neft_code" class="form-control">
                  </div>
                  <div class="form-group col-md-3">
                    <label for="swift_no"><strong>Swift Number:</strong></label>
                    <input type="text" name="swift_no" value="<?php echo $contract_info->swift_no ?>" id="swift_no" class="form-control">
                  </div>
                  <div class="form-group col-md-3">
                    <label for="micr_no"><strong>MICR Number:</strong></label>
                    <input type="text" name="micr_no" value="<?php echo $contract_info->micr_no ?>" id="micr_no" class="form-control">
                  </div>
                  <div class="form-group col-md-3">
                    <label for="billing_currency"><strong>Billing & Settlement Currency:</strong></label>
                    <input type="text" name="billing_currency" value="<?php echo $contract_info->billing_currency ?>" id="billing_currency" class="form-control">
                  </div>
                </div>
               <!--  <div class="row border_row">
                  <div class="form-group col-md-3">
