    ...
    <div class="row">
      <div class="col-md-12">
        <div class="pageheader">
          <h2>Manage Hotel Room Rates<span></span></h2>
    ...
    <div class="pagecontent">
        ...
        <div class="col-md-12">
          <section class="boxs">
            ...
            <div class="boxs-body">
              ...
              <form action="<?php echo site_url(); ?>hotel/manageRoomRates" method="get" class="" role="form" data-parsley-validate>
                <div class="row border_row">
                  ...
                  <div class="form-group col-md-2" style="margin-top: 22px;">
                   ...
                   <div class="form-group col-md-1" style="margin-top: 22px;" id="viewEditRoomRates">
                    <a class="btn btn-success" href="<?php echo site_url() ?>hotel/view_step5?id=<?php echo $hotel_id ?>" target="_blank">View/Edit Room Rates</a>
                  </div>
                </div>                
              </form>
              <?php } else { ?>
            ...
            <?php if(!empty($room_rate_details)){ ?>
              <div class="row border_row">
                <div class="form-group col-md-12">
                  <a  href="<?php echo site_url() ?>hotel/manageRoomRates?id=<?php echo $hotel_id; ?>&id1=<?php echo $room_id; ?>" class="btn btn-success"><?php echo $room_details[0]->room_name.' - '.$room_type_arr[0]->name;?></a>
              ...
              <div class="row border_row">
               <div class="form-group col-md-4">
                <label class="strong" for="rate_name">Room Rate Name<span style="color: red;font-weight: bold;"> *</span> : </label>
                <input name="rate_name" id="rate_name" value="<?php echo $room_rate_details[0]->rate_name; ?>" type="text" class="form-control" required="required" readonly="readonly">
              ...
              <div class="form-group col-md-4">
                ...
                <input name="rate_code" id="rate_code" value="<?php echo $room_rate_details[0]->rate_code; ?>" type="text" class="form-control" readonly="readonly">
              </div>
            </div>
            <div class="row border_row"> 
              <div class="form-group col-md-12">
                <label class="strong" for="rate_desc">Room Rate Description : </label>
                <textarea name="rate_desc" class="form-control ckeditor" rows="3" required="required" id="rate_desc" readonly="readonly"><?php echo $room_rate_details[0]->rate_desc; ?></textarea>
              </div> 
            </div>
            <div class="row border_row">
              <div class="form-group col-md-4">          
                <ul class="check_width check_icon">
                  <?php if($room_rate_details[0]->rate_type=='nett'){ ?>
                 ...
                 <?php } if($room_rate_details[0]->rate_type=='commission'){ ?>
              ...
              <div class="form-group col-md-4" id="commissionId" style="display: none;">
                ...
                <select name="commission" id="commission" class="form-control select2" <?php if($room_rate_details[0]->rate_type=='commission'){ echo "required" ;} ?> readonly="readonly"> 
              ...
              <div class="form-group col-md-4" id="published_rateId">
                ...
                <input name="published_rate" id="published_rate" value="<?php echo $room_rate_details[0]->published_rate; ?>" type="text" class="form-control" <?php if($room_rate_details[0]->rate_type=='nett'){ echo "required" ;} ?> data-parsley-rate="">
              </div>
            </div>
               ...
               <div class="row border_row">               
                <div class="form-group col-md-2">
                  ...
                  <input name="single_occupancy_rate" id="single_occupancy_rate" value="<?php echo $room_rate_details[0]->single_occupancy_rate; ?>" type="text"   class="form-control" required="required" data-parsley-rate="">
                </div>
                <div class="form-group col-md-2">
                  <label class="strong" for="twin_occupancy_rate">Double/Twin Occupancy<span style="color: red;font-weight: bold;"> *</span> : </label>
                  <input name="twin_occupancy_rate" id="twin_occupancy_rate" value="<?php echo $room_rate_details[0]->twin_occupancy_rate; ?>" type="text"   class="form-control" required="required" data-parsley-rate="">
                </div>
                <div class="form-group col-md-3">
                  ...
                  <input name="triple_occupancy_rate_extrabed" id="triple_occupancy_rate_extrabed" value="<?php echo $room_rate_details[0]->triple_occupancy_rate_extrabed; ?>" type="text"   class="form-control" required="required" data-parsley-rate="">
                </div>
                <div class="form-group col-md-2">
                  <label class="strong" for="triple_occupancy_rate">Triple Occupancy<span style="color: red;font-weight: bold;"> *</span> : </label>
                  <input name="triple_occupancy_rate" id="triple_occupancy_rate" value="<?php echo $room_rate_details[0]->triple_occupancy_rate; ?>" type="text"   class="form-control" required="required" data-parsley-rate="">
                </div>
                <div class="form-group col-md-2">
                  <label class="strong" for="quad_occupancy_rate">Quad Occupancy<span style="color: red;font-weight: bold;"> *</span> : </label>
                  <input name="quad_occupancy_rate" id="quad_occupancy_rate" value="<?php echo $room_rate_details[0]->quad_occupancy_rate; ?>" type="text"   class="form-control" required="required" data-parsley-rate="">
                </div>
              </div>
              <div class="row border_row">
                <div class="form-group col-md-4">
                  <label class="strong" for="childminage">Child Min Age<span style="color: red;font-weight: bold;"> *</span> : </label>
                  <select name="childminage" id="childminage" class="form-control select2" required="required" readonly="readonly"> 
                ...
                <div class="form-group col-md-4">
                  ...
                  <select name="childmaxage" id="childmaxage" class="form-control select2" required="required" readonly="readonly"> 
                    <option value="">Select</option>
                    <?php for($i=1;$i<=12;$i++){?>
                ...
                <div class="form-group col-md-4">
                  ...
                  <input name="child_rate" id="child_rate" value="<?php echo $room_rate_details[0]->child_rate; ?>" type="text"   class="form-control" required="required" data-parsley-rate="">                  
                </div>
              </div>
          ...
          <div class="row border_row">
            <div class="form-group col-md-2">
             <ul class="check_width2 check_icon">
              <li><label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm"><input type="checkbox" name="taxes_included" value="true" id="taxes_included" <?php if($room_rate_details[0]->taxes_included=='true'){ echo "checked" ;} ?> readonly="readonly" onclick="return false;"><i></i>Taxes included(Recommended)</label></li> </ul>
            </div>
            <div class="form-group col-md-2">
              <label class="strong" for="supplier_tax_percent">Partner Tax percent<span style="color: red;font-weight: bold;"> *</span> : </label>
              <input name="supplier_tax_percent" id="supplier_tax_percent" value="<?php echo $room_rate_details[0]->supplier_tax_percent; ?>" type="text" class="form-control" required="required" data-parsley-tax=""  min="0" max="100">
            </div>           
            <div class="form-group col-md-2">
              <label class="strong">Local Currency<span style="color: red;font-weight: bold;"> *</span> :</label>
              <select name="currency_type" class="form-control select2" required readonly="readonly">
          ...
          <div class="form-group col-md-6">
                   ...
                   <div class="form-group col-md-6">
                    <?php if($weekdays==1){ ?>
                     ...
                     <div class="input-group">
                        <input type="text" class="form-control" id="start_date" name="start_date" placeholder="Select From Date" value="<?php echo date('d-m-Y',strtotime($room_rate_details[0]->start_date)); ?>" required="required" readonly="readonly">
                ...
                <!--  -->            
                 ...
                 <div class="form-group col-md-6">
                    <?php if($weekdays==1){ ?>
                         ...
                         <!--  -->
                   <div class="input-group">
                     <input type="text" class="form-control" id="end_date" name="end_date" placeholder="Select To Date"   value="<?php echo date('d-m-Y',strtotime($room_rate_details[0]->end_date)); ?>" required="required" readonly="readonly">
                      <label class="input-group-addon btn" for="date">
                         <span class="fa fa-calendar"></span>
                      </label>
                  </div>
              ...
              <?php if($weekdays==1){
                $weekdays_arr=explode(',', $room_rate_details[0]->weekdays);
                 if(!empty($weekdays_arr)){ ?>
                 <div class="row border_row">
                <div class="form-group col-md-10">
                  <label class="strong" for="room_count">Weekend Days :</label>
                  <ul class="check_width2 check_icon">
                    <li><label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm"><input type="checkbox" name="weekdays[]" class="flat" value="Mon" <?php if(in_array('Mon',$weekdays_arr)){  echo "checked"; }?>><i></i> Monday</label></li>
                    <li><label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm"><input type="checkbox" name="weekdays[]" class="flat" value="Tue" <?php if(in_array('Tue',$weekdays_arr)){  echo "checked"; }?>><i></i> Tuesday</label></li>
                    <li><label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm"><input type="checkbox" name="weekdays[]" class="flat" value="Wed" <?php if(in_array('Wed',$weekdays_arr)){  echo "checked"; }?>><i></i> Wednesday</label></li>
                    <li><label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm"><input type="checkbox" name="weekdays[]" class="flat" value="Thu" <?php if(in_array('Thu',$weekdays_arr)){  echo "checked"; }?>><i></i> Thursday</label></li>
                    <li><label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm"><input type="checkbox" name="weekdays[]" class="flat" value="Fri" <?php if(in_array('Fri',$weekdays_arr)){  echo "checked"; }?>><i></i> Friday</label></li>
                    <li><label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm"><input type="checkbox" name="weekdays[]" class="flat" value="Sat" <?php if(in_array('Sat',$weekdays_arr)){  echo "checked"; }?>><i></i> Saturday</label></li>
                    <li><label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm"><input type="checkbox" name="weekdays[]" class="flat" value="Sun" <?php if(in_array('Sun',$weekdays_arr)){  echo "checked"; }?>><i></i> Sunday</label></li>
                  </ul>
                </div>
              </div>
                <?php } else { ?>
                ...
                <div class="form-group col-md-10">
                  <label class="strong" for="room_count">Weekend Days :</label>
                  <ul class="check_width2 check_icon">
                    <li><label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm"><input type="checkbox" name="weekdays[]" class="flat" value="Mon"><i></i> Monday</label></li>
                    <li><label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm"><input type="checkbox" name="weekdays[]" class="flat" value="Tue"><i></i> Tuesday</label></li>
                    <li><label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm"><input type="checkbox" name="weekdays[]" class="flat" value="Wed"><i></i> Wednesday</label></li>
                    <li><label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm"><input type="checkbox" name="weekdays[]" class="flat" value="Thu"><i></i> Thursday</label></li>
                    <li><label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm"><input type="checkbox" name="weekdays[]" class="flat" value="Fri"><i></i> Friday</label></li>
                    <li><label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm"><input type="checkbox" name="weekdays[]" class="flat" value="Sat" checked="checked"><i></i> Saturday</label></li>
                    <li><label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm"><input type="checkbox" name="weekdays[]" class="flat" value="Sun" checked="checked"><i></i> Sunday</label></li>
                  </ul>
                </div>
              </div>
              <?php } } ?>
            ...
            <div class="form-group col-md-10">
              ...
              <ul class="check_width check_icon">
                ...
                if(!empty($room_rate_include))
                {
                  ...
                  {
                    ?>
                    <?php if(in_array($room_rate_include[$j]->id, $room_rate_include_arr)){ ?>
                    <li><label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm"><input type="checkbox" name="room_rate_include[]" class="flat" value="<?php echo $room_rate_include[$j]->id;?>" <?php if(in_array($room_rate_include[$j]->id, $room_rate_include_arr)){ echo "checked"; }?> readonly="readonly" onclick="return false;"><i></i> <?php echo $room_rate_include[$j]->name;?></label></li>
                    <?php }}  }?>                     
                  </ul>
                </div>
              </div>
              ...
              <div class="row border_row">
               ...
               <div class="form-group col-md-6 check_icon">                 
                <label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm">
                  <input type="checkbox" class="flat"  name="non_refundable" value="non_refundable" <?php  echo $checked; ?> readonly="readonly" onclick="return false;">
                  <i></i> Non Refundable
                </label>               
              </div> 
            </div>
          ...
          <?php 
            ...
            <div class="row  border_row policy_row">
              <div class="form-group col-md-3">
               <select name="cancel_rates_type[]" class="form-control cancel_rates_type" onchange="cancel_rates_type(this)" required="required" readonly="readonly">              
                 <option value="percentage" <?php if($val[1]=="percentage"){ echo 'selected'; } ?>>Percentage</option>              
               </select>
               </div> 
              <div class="form-group col-md-3">
                <input type="text" name="days_before[]"  class="form-control days_before"  placeholder="No of Days" value="<?php echo $key;?>" required="required" readonly="readonly"/>
              </div>
              <div class="form-group col-md-3">
                <input type="text" name="cancel_rates[]"  class="form-control cancel_rates" value="<?php echo $val[0];?>" placeholder="Percentage(%)"   required="required" readonly="readonly"/>
              </div>                          
            </div> 
            <?php }} else{ ?> 
            <div class="row  border_row policy_row">
      ...
      <div class="row border_row">
        <div class="form-group col-md-4">
          ...
          <div class="input-group">
            <input type="text" name="check_in_policy" value="<?php echo $room_rate_details[0]->check_in_policy; ?>" class="form-control datepicker" id="timepicker11" data-format="LT" required readonly="readonly"/>
        ...
        <div class="form-group col-md-4">
          ...
          <div class="input-group">
            <input type="text" name="check_out_policy" value="<?php echo $room_rate_details[0]->check_out_policy; ?>" class="form-control datepicker" data-format="LT" id="timepicker22"  required readonly="readonly"/>
      ...
      <div class="row border_row"> 
        <div class="form-group col-md-12">
          ...
          <textarea name="children_policy" class="form-control ckeditor" rows="3" required="required" id="children_policy" readonly="readonly"><?php echo $room_rate_details[0]->children_policy; ?></textarea>
        </div> 
      </div> 
              ...
              <tbody>
                ...
                if(!empty($room_rate_list)){
                 ...
                 <tr>
                  ...
                  <td><?php echo $room_rate_list[$i]->weekdays; ?></td> 
                 <td><a class="btn btn-info btn-xs" href="<?php echo site_url(); ?>hotel/manageRoomRates?id=<?php echo $room_rate_list[$i]->hotel_id;?>&id1=<?php echo $room_rate_list[$i]->room_id;?>&id2=<?php echo $room_rate_list[$i]->sup_hotel_room_rates_list_id;?>&code=<?php echo $room_rate_list[$i]->room_rate_code;?>&weekdays=1"><i class="fa fa-pencil"></i> Edit Weekdays Rate</a></td>              
                  <td><a class="btn btn-info btn-xs" href="<?php echo site_url(); ?>hotel/manageRoomRates?id=<?php echo $room_rate_list[$i]->hotel_id;?>&id1=<?php echo $room_rate_list[$i]->room_id;?>&id2=<?php echo $room_rate_list[$i]->sup_hotel_room_rates_list_id;?>&code=<?php echo $room_rate_list[$i]->room_rate_code;?>"><i class="fa fa-pencil"></i> Edit Rate</a></td> 
...
<!--/ custom javascripts -->
   <script>
    ...
    if (typeof rate_desc !== "undefined"||typeof children_policy !== "undefined") 
    { 
   ...
   var id=$(t).val();
    $.ajax({
      ...
      {     
        ...
        $("#viewEditRoomRates").html(data.viewEditRoomRates);
        } else{
         $("#id1").html('<option value="">Select Room</option>');
        $("#viewEditRoomRates").html('');
        }
      }
  });
  }
  ...
  function (value, requirement) {    
     ...
     if(parseInt($("#childminage").val())>parseInt($("#childmaxage").val()))
   {
    ...
    if (!form.parsley().isValid()) {
      ...
      $.ajax({
        type: 'post',
        url: '<?php echo site_url(); ?>hotel/updateHotelRoomRates/'+$ins_id+'/'+$ins_id1,
      ...
      success: function(data) {
        ...
        if(todo == 1){
          ...
          location.href='<?php echo site_url();?>hotel/manageRoomRates?id='+$ins_id1+'&id1='+$ins_id2;
        }
      }
    });
    }
...
<script>
  ...
  $(document).ready(function() {
    $(".select2").select2({  
      ...
      <?php if(!empty($room_rate_details)){ ?>
         readonly_select($(".select2_single,.select2_multiple,.select2"), true);  
    <?php } ?>
  });
</script>
<?php if(!empty($room_rate_details)){ ?>
