    ...
    <div class="row">
      <div class="col-md-12">
        <div class="pageheader">
          <h2>Add Rooms <span></span></h2>
          <div class="page-bar br-5">
            <ul class="page-breadcrumb">
              <li><a href="<?php echo site_url() ?>"><i class="fa fa-home"></i> Dashboard</a></li>
              <li><a href="#">Hotels</a></li>
              <li><a class="active" href="#">Add Rooms</a></li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <div class="pagecontent">
      <div id="rootwizard" class="form_wizard wizard_horizontal tab-wizard">
        <ul class="wizard_steps">
          ...
          <li><a href="#step-2" data-toggle="tab"><span class="step_no wizard-step">2</span><span class="step_descr">Step 2<br><small>Contact Info</small></span></a></li>
          ...
          <li><a href="#step-4" data-toggle="tab"><span class="step_no wizard-step">4</span><span class="step_descr">Step 4<br><small>Meta Info</small></span></a></li>
            ...
            <form class="step_form step1" steps="1" name="step1" role="form">
              <div class="row border_row">
                ...
                <div class="form-group col-md-4">
                  ...
                  <input name="hotel_name" id="hotel_name" type="text" class="form-control">
                </div>
                <div class="form-group col-md-4">
                  <label class="strong" for="year_built">Year Built : </label>
                  <input type="text" name="year_built" id="year_built" class="form-control">
                </div>
              </div>
              <div class="row border_row">
                <div class="form-group col-md-4">
                  <label class="strong" for="room_count">Total No of Rooms : </label>
                  <input type="text" name="room_count" id="room_count" class="form-control">
                </div>
                <div class="form-group col-md-4">
                  <label class="strong">Property Type : </label>
              ...
              <div class="row border_row">
                <div class="form-group col-md-10">
                  <label class="strong" for="room_count">Hotel Facilities : </label>
