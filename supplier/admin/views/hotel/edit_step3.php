            ...
            <div class="tab-pane active" id="step-3">
              <div class="row border_row">
                <div class="form-group col-md-10">
                  <label class="strong">Resort Amenities  : <a href="<?php echo site_url() ?>facility_type/facilitytype" target="_blank"><i class="fa fa-plus"></i> Add More</a></label>
                  <ul class="check_width check_icon">
                    ...
                    <li>
                      <label class="checkbox-inline checkbox-custom2 checkbox-custom2-sm">
                        <input type="checkbox" name="hotel_facilities[]" class="flat" value="<?php echo $hotel_facilities[$i]->id;?>" <?php if(in_array($hotel_facilities[$i]->id, $facilities)) echo "checked"; ?>><i></i> <?php echo $hotel_facilities[$i]->facility; ?>
                      </label>
                    </li>
                   <?php } }?>
                  </ul>
