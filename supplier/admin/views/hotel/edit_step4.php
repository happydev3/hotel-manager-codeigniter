                ...
                <div class="col-md-12">
                  ...
                  <?php if(!empty($hotel_details[0]->thumb_img)){ ?>
                    <div class="priv_div" style="position:relative;display:inline-block">
                      <img src="<?php if(!empty($hotel_details[0]->thumb_img)) echo get_image_aws($hotel_details[0]->thumb_img); ?>" title="" class="thumbimage" />
                    </div>
                    <?php } ?>
                  </div>
                  <?php echo '</form>' ?>
                ...
                <div class="col-md-12">
                  ...
                  <ul id="sortable" class="row2 dragdiv" style="margin-top: 5px">
                    ...
                    <li class="priv_div ui-state-default" id="item-<?php echo $gal->id ?>" style="position:relative;display:inline-block" img_id="<?php echo $gal->id ?>">
                      <img src="<?php if(!empty($gal->gallery_img)) echo get_image_aws($gal->gallery_img); ?>" img_url="<?php echo $gal->gallery_img ?>" title="" class="thumbimage" /><i class="fa fa-close delete_img"></i>
                    </li>
                    <?php }} ?>
                  </ul>
...
<script type="text/javascript">
  $('#sortable').sortable({
    ...
    update: function (event, ui) {
        ...
        $.ajax({
            data: data+'&hotel_id=<?php echo $hotel_id ?>',
            type: 'POST',
            url: '<?php echo site_url(); ?>hotel/sortImages',
            beforeSend: function(){
              _parent.find(".messages2").html('<p><img src = "<?php echo get_image_aws('public/images/load.gif'); ?>" class = "loader" /></p>');
            },
            success: function(){
