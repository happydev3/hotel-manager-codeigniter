...
?>
        ...
        <div class="tab-content">
          <form action="<?php echo site_url() ?>sightseeing/update_all" method="post" class="step_form step4" steps="4" name="step4" role="form" enctype="multipart/form-data" novalidate>
