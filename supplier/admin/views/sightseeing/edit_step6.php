...
?>
        ...
        <div class="tab-content">
          <form action="<?php echo site_url() ?>sightseeing/update_all" method="post" class="step_form step6" steps="6" name="step6" method="POST" enctype="multipart/form-data" role="form" novalidate>
            ...
            <div class="tab-pane active" id="step-6">
              <div id="attraction_wrapper">
                ...
                <?php if(!empty($sightseeing_attraction)) { ?>
                <div id="attraction_field_wrapper">
                  <?php for($i=0;$i<count($sightseeing_attraction);$i++) { ?>
                    ...
                    <div class="boxs-body">
                      <div class="row border_row">
                        <div class="form-group col-sm-4">
                          ...
                          <input type="text" name="attraction_name[]" value="<?php echo $sightseeing_attraction[$i]->attraction_name ?>" class="form-control">
                        </div>
                        <div class="form-group col-sm-4">
                          <label class="strong">Active Day</label>
                          <select name="attraction_day[]" class="form-control active_day">
                            <?php for($d=1;$d<=$duration;$d++){ ?>
                            <option value="<?php echo $d ?>" <?php if($sightseeing_attraction[$i]->attraction_day==$d) echo 'selected' ?>>Day <?php echo $d ?></option>
                            <?php } ?>
                          </select>
                        </div>
                      </div>
                      <div class="row border_row">
                        <div class="form-group col-sm-12">
                          ...
                          <textarea name="attraction_description[]" id="attraction_description<?php echo $i+1 ?>" class="form-control ckeditor" rows="3" cols="100"><?php echo $sightseeing_attraction[$i]->attraction_description ?></textarea>
                        </div>
                      </div>
                      <div class="row border_row">
                        <div class="form-group col-sm-4">
                          <label class="strong">Adult Cost</label>
                          <input type="text" name="attraction_adult_cost[]" value="<?php echo $sightseeing_attraction[$i]->attraction_adult_cost ?>" class="form-control">
                        </div>
                        <div class="form-group col-sm-4">
                          <label class="strong">Child Cost(Below 12 years)</label>
                          <input type="text" name="attraction_child_cost[]" value="<?php echo $sightseeing_attraction[$i]->attraction_child_cost ?>" class="form-control">
                        </div>
                        <div class="form-group col-sm-4">
                          <label class="strong">Family Cost(2 Adults + 2 Children)</label>
                          <input type="text" name="attraction_family_cost[]" value="<?php echo $sightseeing_attraction[$i]->attraction_family_cost ?>" class="form-control">
                        </div>
                      </div>
                      <div class="row border_row min_height200">
                        <div class="col-md-12">
                          ...
                          <input type="hidden" name="table_name" value="sightseeing_attraction_images">
...
$('.upload_now').on('click', function(){
    ...
    data.append('table_name', 'sightseeing_attraction_images');
