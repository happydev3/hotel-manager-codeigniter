...
?>
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="step-7">
            <form action="<?php echo site_url() ?>sightseeing/update_all" method="post" class="step_form step7" steps="7" name="step7" role="form" id="submit_form" enctype="multipart/form-data" novalidate>
            ...
            <div class="row border_row min_height200">
              <div class="col-md-12">
                ...
                <input type="hidden" name="controller" value="sightseeing">
                <input type="hidden" name="id" value="<?php echo $package_id ?>">
                <input type="hidden" name="id_column" value="id">
                <input type="hidden" name="table_name" value="sightseeing_packages">
            ...
            <div class="row border_row min_height200">
              <div class="col-md-12">
                ...
                <input type="hidden" name="table_name" value="sightseeing_package_images">
          ...
          <ul class="pager wizard">
            <li class="previous">
              <a href="<?php echo str_replace('supplier/', '', site_url()) ?>sightseeing/preview_sightseeing/<?php echo $package_id ?>" target="_blank" class="fa fa-eye btn btn-default"> Preview</a>
            </li>
            <li class="next finish">
              <!-- <a href="<?php echo site_url() ?>sightseeing/sightseeing_list" class="btn btn-success">Finish</a> -->
...
$('.upload_now').on('click', function(){
    ...
    data.append('table_name', 'sightseeing_package_images');
