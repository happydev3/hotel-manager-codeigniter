...
?>
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="step-5">
            <form action="<?php echo site_url() ?>attraction/update_all" method="post" class="step_form step5" steps="5" name="step5" role="form" id="submit_form" enctype="multipart/form-data" novalidate>
            ...
            <div class="row border_row min_height200">
              <div class="col-md-12">
                ...
                <input type="hidden" name="controller" value="attraction">
                <input type="hidden" name="id" value="<?php echo $package_id ?>">
                <input type="hidden" name="id_column" value="id">
                <input type="hidden" name="table_name" value="attraction_packages">
            ...
            <div class="row border_row min_height200">
              <div class="col-md-12">
                ...
                <input type="hidden" name="table_name" value="attraction_package_images">
          ...
          <ul class="pager wizard">
            <li class="previous">
              <a href="<?php echo str_replace('supplier/', '', site_url()) ?>attraction/preview_attraction/<?php echo $package_id ?>" target="_blank" class="fa fa-eye btn btn-default"> Preview</a>
            </li>
...
$('.upload_now').on('click', function(){
    ...
    data.append('table_name', 'attraction_package_images');
