        ...
        <div class="pageheader">
          ...
          <div class="page-bar br-5">
            <ul class="page-breadcrumb">
              ...
              <li><a class="active">Add Attraction</a></li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <div class="pagecontent">
      <div id="rootwizard" class="form_wizard wizard_horizontal tab-wizard">
        <ul class="wizard_steps">
          ...
          <li><a href="#step-5" data-toggle="tab"><span class="step_no wizard-step">5</span><span class="step_descr">Step 5<br><small>Images <div class="backets_info">(Preview &amp; Save)</div></small></span></a></li>
        </ul>
        ...
        <div class="tab-content">
              ...
              <div class="row border_row">
                <div class="form-group col-md-4">
                  ...
                  <div class="check_icon">
                    <label class="checkbox-inline radio-custom2 radio-custom2-sm"><input type="radio" name="attraction_type" value="Private" checked><i></i> Private</label>
                    <label class="checkbox-inline radio-custom2 radio-custom2-sm"><input type="radio" name="attraction_type" value="Scheduled"><i></i> Scheduled <div class="backets_info">(SIC)</div></label>
                  </div>
                </div>
                <div class="form-group col-md-4">
                  <label class="strong" for="attraction_name">Attraction Name : </label>
                  <input name="attraction_name" id="attraction_name" type="text" class="form-control" autofocus="autofocus" required>
                </div>
                <div class="form-group col-md-4">
                  <label class="strong" for="attraction_code">Attraction Code : </label>
                  <input type="text" name="attraction_code" id="attraction_code" class="form-control" required>
                </div>
              </div>
              <div class="row border_row">
          ...
          <ul class="pager wizard">
            ...
            <li class="next finish" style="display:none;">
              <a href="<?php echo site_url() ?>attraction/attraction_list" class="btn btn-success">Finish</a>
            </li>
          </ul>
        </div>
      </div>
...
function save_attraction(form, steps, todo){
    $ins_id = $("#insert_id").val();
    // alert(steps)
    $href = '<?php echo str_replace('supplier/', '', site_url()) ?>'+'attraction/preview_attraction/'+$ins_id;
    $('#previewid').attr('href', $href);

    $.ajax({
      type: 'post',
      url: '<?php echo site_url(); ?>attraction/save_attraction_'+steps+'/'+$ins_id,
      ...
      success: function(data) {
        ...
        $(".package_id").val(data.insert_id);
        if(todo == 1){
          window.location.replace('<?php echo site_url();?>attraction/edit_step2?id='+data.insert_id);
        } else{
          window.location.replace('<?php echo site_url();?>attraction/edit_attraction?id='+data.insert_id);
        }
