    ...
    <div class="pagecontent">
      <div class="row">
        <div class="col-md-12">
          <section class="boxs">
            <div class="boxs-body">
              <form action="<?php echo site_url(); ?>branch/create_branch" method="post" class="" role="form" data-parsley-validate>
                <div class="row border_row">
                  ...
                  <input type="hidden" name="branch_type" class="form-control" value="1">
                </div>
                <div class="row border_row">
            ...
            <div class="table-responsive">
              <table class="table table-custom" id="advanced-usage">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><?php echo $i+1; ?></td>
                    <td><?php echo $branches[$i]->branch_name ?></td>
                    <td><?php echo $branches[$i]->physical_address ?></td>
                    <td><?php echo $branches[$i]->telephone_no ?></td>
                    <td><?php echo $branches[$i]->emergency_contact ?></td>
                    <td><?php echo $branches[$i]->timezone ?></td>
                    <td><a class="btn btn-info btn-xs" href="<?php echo site_url(); ?>branch/edit_branch?id=<?php echo $branches[$i]->branch_id; ?>/1"><i class="fa fa-pencil"></i> Edit</a></td>
                  </tr>
                  <?php } ?>
                  <?php } ?>
                </tbody>
