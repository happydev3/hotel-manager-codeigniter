            ...
            <div class="boxs-body">
              <form action="<?php echo site_url(); ?>branch/create_branch" method="post" class="" role="form" data-parsley-validate>
                <div class="row border_row">
                  ...
                  <input type="hidden" name="branch_type" class="form-control" value="2">
                </div>
                <div class="row border_row">
              ...
              <table class="table table-custom" id="advanced-usage">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a class="btn btn-info btn-xs" href="<?php echo site_url(); ?>branch/edit_head?id=<?php echo $branches[$i]->branch_id; ?>/2"><i class="fa fa-pencil"></i> Edit</a></td>
                  </tr>
                  <?php } ?>
                  <?php } ?>
                </tbody>
