        ...
        <div class="pageheader">
          ...
          <div class="page-bar  br-5">
            <ul class="page-breadcrumb">
              ...
              <li><a class="active" href="<?php echo site_url() ?>business_type/view_business_type_info/<?php echo $id; ?>">Edit Business Type</a></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-12">
        ...
        <form id="basicForm" class="form-horizontal" action="<?php echo site_url() ?>business_type/<?php echo $action ?>" enctype="multipart/form-data" method="post">
           <div class="form-group">                     
             ...
             <div class="col-sm-2">
              <input class="form-control" id="focusedInput" type="text" name="business_type" value="<?php echo $businesstype->business_type;?>" required="">
              <input type="hidden" name="id" value="<?php echo $id;?>">
            </div>
            <div class="col-md-2">
              <button type="submit" class="btn btn-primary"><?php echo $button ?></button>
               <a  href="<?php echo site_url(); ?>business_type/businesstype" class="btn btn-primary">Cancel</a>
            </div>
          </div>   
        </form>     
      </div>
