              ...
              <div class="row border_row">
                <div class="form-group col-md-4">
                  ...
                  <select class="form-control select2" name="holiday_id" id="holiday_id" required="required">
                    ...
                    <option value="<?php echo $val->id ?>" <?php if($val->id == $block_details->holiday_id) echo "selected"; ?>><?php echo $val->package_title ?></option>
                    <?php } ?>
                  </select>
                </div>
                <div class="form-group col-md-4">
                  ...
                  <select class="form-control select2" name="activity_id" id="activity_id" required="required">
                    ...
                    <option value="<?php echo $block_details->activity_id ?>" selected><?php echo $this->db->select('activity_title')->from('holiday_activity')->where('id', $block_details->activity_id)->get()->row()->activity_title ?></option>
                  </select>
                </div>
                <div class="form-group col-md-4">
