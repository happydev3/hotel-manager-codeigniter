                ...
                <div class="tbox tbox-sm">
                  <div class="tcol">
                    <div class="p-15">
                      ...
                      <h2 class="custom-font text-default m-0"><strong><small>Hotel <?php echo $hotel_detail->hotel_name; ?><br/><span style="color: red;font-weight: 800;" >Allotment Details</small></strong></h2>
                      </div>
                      <div class="p-15">
                        <div id='calendar'></div>
                      </div>
   ...
   $('.changecal').on( "click", function(){
    ...
    function loadroomrates1()
       ...
       $.ajax({       
        ...
        data: 'hotel_id='+$hotel_id+'&hotel_code='+$hotel_code+'&startdate='+$startdate+'&enddate='+$enddate,
        dataType: 'json',
        type: 'POST',
        beforeSend: function(){
    ...
    function loadroomrates($t='')
       ...
       $.ajax({       
        ...
        data: 'hotel_id='+$hotel_id+'&hotel_code='+$hotel_code+'&month='+$getmonth+'&year='+$getyear,
        dataType: 'json',
        type: 'POST', 
        beforeSend: function(){
           $('#loadroomratesajax').modal('show'); 
