...
<div class="row">
  <div class="form-group col-md-3">
    <label class="strong" for="child_rate">Add Room Rate: </label>
    <input name="child_rate" id="child_rate" type="text"  placeholder="Add Room Rate" class="form-control checkzero deciNum" required="required" />
  </div>
</div>
<div class="row">
  <div class="form-group col-md-3">
