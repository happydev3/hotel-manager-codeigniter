           ...
           <div id="add_rate_type">
              ...
              <div class="row">
                <div class="form-group col-md-3">
                  ...
                  <input name="adult_rate" id="adult_rate" type="text"  placeholder="Add Adult Rate" class="form-control checkzero deciNum"  value="<?php echo $post_data['adult_rate'];?>" required="required" />
                </div>
              </div>
              <div class="row">
                <div class="form-group col-md-3">
                  <label class="strong" for="child_rate">Add Child Rate: </label>
                  <input name="child_rate" id="child_rate" type="text"  placeholder="Add Child Rate" class="form-control checkzero deciNum"  value="<?php echo $post_data['child_rate'];?>" required="required" />
                </div>
              </div>
               <div class="row">
                <div class="form-group col-md-3">
