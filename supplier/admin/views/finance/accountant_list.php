        ...
        <div class="pageheader">
          ...
          <div class="page-bar br-5">
            <ul class="page-breadcrumb">
              ...
              <li><a class="active">Accountant List</a></li>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a class="btn btn-success btn-xs" href="<?php echo site_url(); ?>accountant/set_status/<?php echo $accountant_info[$i]->account_id;  ?>/1" onclick="return confirm('Do you really want to Active this Package. ?')"><i class="fa fa-check"></i> Active</a>
                      <?php } else { ?>
                      <a class="btn btn-danger btn-xs" href="<?php echo site_url(); ?>accountant/set_status/<?php echo $accountant_info[$i]->account_id;  ?>/0" onclick="return confirm('Do you really want to InActive this Package. ?')"><i class="fa fa-times"></i> Inactive</a>
                      <?php } ?>
                    </td>
                    <td><a class="btn btn-info btn-xs" href="<?php echo site_url(); ?>accountant/edit_accountant?id=<?php echo $accountant_info[$i]->account_id; ?>"><i class="fa fa-pencil"></i>Edit</a></td>
