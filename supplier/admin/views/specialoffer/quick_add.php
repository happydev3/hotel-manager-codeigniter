        ...
        <div class="pageheader">
          ...
          <div class="page-bar  br-5">
            <div class="form-group">
              <a href="<?php echo site_url() ?>hotel/quick_add" class="btn btn-success" type="button"><i class="fa fa-list m-right-xs"></i> Add Your Property</a>
            </div>
          </div>
        </div>
      </div>
              ...
              <form id="quick_add" name="quick_add" class="" role="form" data-parsley-validate>
                <div class="row">
                  <div class="form-group col-md-6">
                    <label for="hotel_name"><strong>Property Name:</strong></label>
                    <input type="text" name="hotel_name" id="hotel_name" class="form-control" required>
                  </div>
                  <div class="form-group col-md-6">
                    <label for="hotel_code"><strong>Property Id:</strong></label>
                    <input type="text" name="hotel_code" id="hotel_code" class="form-control">
                  </div>
                </div>
                <div class="row">
                  <div class="form-group col-md-6">
                    <label for="hotel_type"><strong>Property Type:</strong></label>
                    <select id="hotel_type" name="hotel_type" class="form-control" type="text">
