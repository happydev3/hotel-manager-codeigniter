        ...
        <div class="pageheader">
          ...
          <div class="page-bar  br-5">
            <ul class="page-breadcrumb">
              ...
              <li><a class="active" href="<?php echo site_url() ?>facility_type/room_amenities">Manage Facilities</a></li>
            </ul>
          </div>
        </div>
      </div>
          ...
          <tbody>
           ...
           <tr>
            ...
            <td class="center">
              ...
              <a class="btn btn-info btn-rounded btn-sm btn-ef btn-ef-5 btn-ef-5a" href="<?php echo site_url(); ?>facility_type/view_facility_type_info/room/<?php echo $facilitytype[$i]->id ?>" title="Edit" ><i class="fa fa-edit"></i> <span>Edit</span></a>
              <?php } ?>
            </td>
            </tr>             
            <?php } ?>
  ...
  $(window).load(function(){
    ...
    $(".manage_facility_type_status").click(function(){ 
     ...
     if(confirm('Are you sure you want to '+ $message+' this Facility Type?')) {
       $.ajax({
        url: $siteUrl + 'facility_type/set_facility_type_status/room',
        data: 'id='+$id+'&status='+$status,
        dataType: 'json',
        type: 'POST',
        success: function(data)
        { window.location.href=$siteUrl + 'facility_type/room_amenities/'; }
      });
     }
   });
