          ...
          <div class="page-bar br-5">
            <div class="form-group">
              <ul class="page-breadcrumb">
                ...
                <li><a class="active" href="<?php echo site_url(); ?>villarates/view_villa_rates">View Villa Rates</a></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-12">
        <section class="boxs">
          <div class="boxs-header dvd dvd-btm">
            <h1 class="custom-font">View  Villa Rates</h1>
            <ul class="controls">
          ...
          <div class="boxs-body">
            <form action="<?php echo site_url();?>villarates/villa_rate_list" method="post">
              ...
              <div class="row border_row">
                ...
                <div class="form-group col-md-2">
                  <input  class="btn btn-success todo" type="submit" value="View Existing Rate">
                </div>
              </div>
            </form>
          </div>
