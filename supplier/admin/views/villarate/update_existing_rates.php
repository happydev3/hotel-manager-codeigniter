          ...
          <div class="page-bar br-5">
            <div class="form-group">
              <ul class="page-breadcrumb">
                ...
                <li><a class="active" href="<?php echo site_url(); ?>villarates/add_villa_rates/<?php echo $id; ?>">Duplicate Villa Rates</a></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-12">
        <section class="boxs">
          <div class="boxs-header dvd dvd-btm">
            <h1 class="custom-font">Duplicate Villa Rates</h1>
            <ul class="controls">
          ...
          <div class="boxs-body">
            ...
            <form data-action="villarates/updateRates/<?php echo $villa_id.'/'; ?>" data-parsley-validate>
              ...
              <div id="loadvillaratedetails">
                ...
                <div class="row">
                  <div class="form-group col-md-6">
                    ...
                    <div class="row">
                      <div class="form-group col-md-6">
                        <input type="text" class="form-control selectdate" id="from_date" name="from_date" placeholder="Select From Date" value="<?php echo date("d-m-Y",strtotime($edit_rates->from_date)); ?>" required="required">
                      </div>
                      <div class="form-group col-md-6">
                        <input type="text" class="form-control selectdate" id="to_date" name="to_date" placeholder="Select To Date" value="<?php echo date("d-m-Y",strtotime($edit_rates->to_date)); ?>" required="required">
                      </div>
                    </div>
                  </div>
                  <div class="form-group col-md-3">
                    <label class="strong" for="villa_rate">Villa Rate: </label>
                    <input name="villa_rate" id="villa_rate" type="text"  placeholder="Add villa Rate" class="form-control" value="<?php echo $edit_rates->villa_rate; ?>"  data-parsley-rate="" min="1" required="required" />
                  </div>
                </div>
              </div>
              <div class="row  border_row"></div>
              <?php
                $cancellation_policy=json_decode($edit_rates->cancellation_policy,true);
                $checked='';
              ...
              <div id="add_policy_group">
                ...
                <div class="row  border_row policy_row">
                  ...
                  <div class="form-group col-md-3">
                    <input type="text" name="days_before[]"  class="form-control days_before"  placeholder="No of Days" value="<?php echo $key;?>" data-parsley-day="" min="1" required="required"/>
                  </div>
                  <div class="form-group col-md-3">
                    <input type="text" name="cancel_rates[]"  class="form-control cancel_rates" value="<?php echo $val[0];?>" placeholder="Percentage(%)" data-parsley-tax="" min="1" max="100" required="required"/>
                  </div>
                </div>
                <?php }} else{ ?>
                <div class="row  border_row policy_row">
                  ...
                  <div class="form-group col-md-3">
                    <input type="text" name="cancel_rates[]"  class="form-control cancel_rates" placeholder="Percentage(%)" data-parsley-tax="" min="1" max="100" required="required"/>
                  </div>
                </div>
                <?php } ?>
              </div>
              <div class="row">
                ...
                <div class="form-group col-md-3" style="padding-top: 23px;">
                  <input  class="btn btn-success" type="button"  onclick="add_rates(this);" value="Add Rates"><a href="<?php echo site_url()?>villarates/add" class="btn btn-primary">Back</a>
                </div>
              </div>
            </form>
          </div>
...
<script type="text/javascript">
  function add_rates(t)
  {
    ...
    var uniqueval = false;
    var form =$(t.form);
    $action = t.form.getAttribute('data-action');
