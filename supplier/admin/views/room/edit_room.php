             ...
             <!--     <div class="row border_row">
              ...
              <div class="row border_row">
                <div class="form-group col-md-6">
                  ...
                  <!-- <input name="inclusions" id="inclusions" value="<?php //echo $room_details[0]->inclusions;?>" type="text" class="form-control"> -->
                  <?php $inclusions = explode(',', $room_details[0]->inclusions) ?>
                  <select name="inclusions[]" class="form-control select2tag" multiple="">
                    <?php if($inclusions[0] != ''){ ?>
                    <?php foreach($inclusions as $incl){ ?>
                    <option value="<?php echo $incl ?>" selected><?php echo $incl; ?></option>
                    <?php } ?>
                    <?php } ?>
                  </select>
                ...
                <div class="form-group col-md-6">
                  ...
                  <!-- <input name="exclusions" id="exclusions" value="<?php //echo $room_details[0]->exclusions;?>" type="text" class="form-control"> -->
                  <?php $exclusions = explode(',', $room_details[0]->exclusions) ?>
                  <select name="exclusions[]" class="form-control select2tag" multiple="">
                    <?php if($exclusions[0] != ''){ ?>
                    <?php foreach($exclusions as $excl){ ?>
                    <option value="<?php echo $excl ?>" selected><?php echo $excl; ?></option>
                    <?php } ?>
                    <?php } ?>
                  </select>
                  <p>Use comma as a seperator(eg ~ TV,AC)</p>
              ...
              <div class="row border_row">
                <div class="form-group col-md-12">
                  ...
                  <textarea name="room_policies" class="form-control" rows="3" id="room_policies"><?php echo $room_details[0]->room_policies ?></textarea>
                </div>
              </div>
              <!-- <div class="row border_row">
                <div class="form-group col-md-12">
                  <label class="strong" for="room_cancel_policies">Room Cancellation Policies : </label>
                  <textarea name="room_cancel_policies" class="form-control" rows="3" id="room_cancel_policies"><?php //echo $room_details[0]->room_cancel_policies ?></textarea>
                </div>
              </div> -->
