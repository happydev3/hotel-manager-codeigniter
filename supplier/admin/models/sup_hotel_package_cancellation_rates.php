...
class sup_hotel_package_cancellation_rates extends MY_Model {

    protected $_table_name = 'sup_hotel_package_cancellation_rates';
   ...
   function delete_room_cancellation_rates($hotel_id, $room_id,$supplier_id,$package_rate_code, $startdate,$enddate) {
