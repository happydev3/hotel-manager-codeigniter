...
class Villarates_Model extends CI_Model {
    ...
    public function add_block_dates($data) {
        ...
        $this->db->insert('villa_blocking_dates', $data);
        return true;
    }
    public function get_block_list($supplier_id) {
        $this->db->select('d.*,l.property_name');
        
        $this->db->from('villa_blocking_dates d');
        $this->db->join('villa_list l','l.property_code = d.villa_id');
    ...
    function update_block_dates($data, $id) {
        $this->db->where('id', $id);
        $this->db->update('villa_blocking_dates', $data);
        return true;
    }
    ...
    function delete_block_date($id,$supplier_id) {
        $this->db->where('id', $id);
        $this->db->where('supplier_id', $supplier_id);
        $this->db->delete('villa_blocking_dates');
    }
