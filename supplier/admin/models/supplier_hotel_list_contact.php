...
class supplier_hotel_list_contact extends MY_Model {

    protected $_table_name = 'supplier_hotel_list_contact';
    ...
    function delete_contact($supplier_id,$supplier_hotel_list_id)
    {
        $this->db->where('supplier_id',$supplier_id);
        $this->db->where('supplier_hotel_list_id',$supplier_hotel_list_id);   
